...
*TripletexApi::ProductexternalApi* | [**search**](docs/ProductexternalApi.md#search) | **GET** /product/external | [BETA] Find external products corresponding with sent data.
