# TripletexApi::TravelExpenseaccommodationAllowanceApi
...
api_instance = TripletexApi::TravelExpenseaccommodationAllowanceApi.new
...
opts = { 
  body: TripletexApi::AccommodationAllowance.new # AccommodationAllowance | JSON representing the new object to be created. Should not have ID and version set.
}
...
opts = { 
  body: TripletexApi::AccommodationAllowance.new # AccommodationAllowance | Partial object describing what should be updated
}
