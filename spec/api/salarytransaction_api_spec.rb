...
# Unit tests for TripletexApi::SalarytransactionApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalarytransactionApi' do
  before do
    # run before each test
    @instance = TripletexApi::SalarytransactionApi.new
  end
  ...
  describe 'test an instance of SalarytransactionApi' do
    it 'should create an instance of SalarytransactionApi' do
      expect(@instance).to be_instance_of(TripletexApi::SalarytransactionApi)
    end
  end
