...
# Unit tests for TripletexApi::TravelExpensepaymentTypeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelExpensepaymentTypeApi' do
  before do
    # run before each test
    @instance = TripletexApi::TravelExpensepaymentTypeApi.new
  end
  ...
  describe 'test an instance of TravelExpensepaymentTypeApi' do
    it 'should create an instance of TravelExpensepaymentTypeApi' do
      expect(@instance).to be_instance_of(TripletexApi::TravelExpensepaymentTypeApi)
    end
  end
