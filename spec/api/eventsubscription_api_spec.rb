...
# Unit tests for TripletexApi::EventsubscriptionApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventsubscriptionApi' do
  before do
    # run before each test
    @instance = TripletexApi::EventsubscriptionApi.new
  end
  ...
  describe 'test an instance of EventsubscriptionApi' do
    it 'should create an instance of EventsubscriptionApi' do
      expect(@instance).to be_instance_of(TripletexApi::EventsubscriptionApi)
    end
  end
