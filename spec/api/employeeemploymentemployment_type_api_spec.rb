...
# Unit tests for TripletexApi::EmployeeemploymentemploymentTypeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmployeeemploymentemploymentTypeApi' do
  before do
    # run before each test
    @instance = TripletexApi::EmployeeemploymentemploymentTypeApi.new
  end
  ...
  describe 'test an instance of EmployeeemploymentemploymentTypeApi' do
    it 'should create an instance of EmployeeemploymentemploymentTypeApi' do
      expect(@instance).to be_instance_of(TripletexApi::EmployeeemploymentemploymentTypeApi)
    end
  end
