...
# Unit tests for TripletexApi::InvoicedetailsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicedetailsApi' do
  before do
    # run before each test
    @instance = TripletexApi::InvoicedetailsApi.new
  end
  ...
  describe 'test an instance of InvoicedetailsApi' do
    it 'should create an instance of InvoicedetailsApi' do
      expect(@instance).to be_instance_of(TripletexApi::InvoicedetailsApi)
    end
  end
