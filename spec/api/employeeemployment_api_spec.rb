...
# Unit tests for TripletexApi::EmployeeemploymentApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmployeeemploymentApi' do
  before do
    # run before each test
    @instance = TripletexApi::EmployeeemploymentApi.new
  end
  ...
  describe 'test an instance of EmployeeemploymentApi' do
    it 'should create an instance of EmployeeemploymentApi' do
      expect(@instance).to be_instance_of(TripletexApi::EmployeeemploymentApi)
    end
  end
