...
# Unit tests for TripletexApi::InvoicepaymentTypeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoicepaymentTypeApi' do
  before do
    # run before each test
    @instance = TripletexApi::InvoicepaymentTypeApi.new
  end
  ...
  describe 'test an instance of InvoicepaymentTypeApi' do
    it 'should create an instance of InvoicepaymentTypeApi' do
      expect(@instance).to be_instance_of(TripletexApi::InvoicepaymentTypeApi)
    end
  end
