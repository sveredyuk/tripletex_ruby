...
# Unit tests for TripletexApi::SalarysettingsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalarysettingsApi' do
  before do
    # run before each test
    @instance = TripletexApi::SalarysettingsApi.new
  end
  ...
  describe 'test an instance of SalarysettingsApi' do
    it 'should create an instance of SalarysettingsApi' do
      expect(@instance).to be_instance_of(TripletexApi::SalarysettingsApi)
    end
  end
