...
# Unit tests for TripletexApi::EmployeeemploymentdetailsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmployeeemploymentdetailsApi' do
  before do
    # run before each test
    @instance = TripletexApi::EmployeeemploymentdetailsApi.new
  end
  ...
  describe 'test an instance of EmployeeemploymentdetailsApi' do
    it 'should create an instance of EmployeeemploymentdetailsApi' do
      expect(@instance).to be_instance_of(TripletexApi::EmployeeemploymentdetailsApi)
    end
  end
  ...
  # 
  # @param [Hash] opts the optional parameters
  # @option opts [Integer] :employment_id Element ID
