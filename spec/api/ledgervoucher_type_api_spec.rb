...
# Unit tests for TripletexApi::LedgervoucherTypeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LedgervoucherTypeApi' do
  before do
    # run before each test
    @instance = TripletexApi::LedgervoucherTypeApi.new
  end
  ...
  describe 'test an instance of LedgervoucherTypeApi' do
    it 'should create an instance of LedgervoucherTypeApi' do
      expect(@instance).to be_instance_of(TripletexApi::LedgervoucherTypeApi)
    end
  end
