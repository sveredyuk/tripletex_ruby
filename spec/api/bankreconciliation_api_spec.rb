...
# Unit tests for TripletexApi::BankreconciliationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankreconciliationApi' do
  before do
    # run before each test
    @instance = TripletexApi::BankreconciliationApi.new
  end
  ...
  describe 'test an instance of BankreconciliationApi' do
    it 'should create an instance of BankreconciliationApi' do
      expect(@instance).to be_instance_of(TripletexApi::BankreconciliationApi)
    end
  end
  ...
  # unit tests for fetch_from_bank
  # [BETA] Create a bank reconciliation by fetching bank statement from the bank.
  # 
  # @param account_id Element ID
  # @param accounting_period_id Element ID
  # @param [Hash] opts the optional parameters
  # @return [ResponseWrapperBankReconciliation]
  describe 'fetch_from_bank test' do
    it "should work" do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
