...
# Unit tests for TripletexApi::LedgercloseGroupApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LedgercloseGroupApi' do
  before do
    # run before each test
    @instance = TripletexApi::LedgercloseGroupApi.new
  end
  ...
  describe 'test an instance of LedgercloseGroupApi' do
    it 'should create an instance of LedgercloseGroupApi' do
      expect(@instance).to be_instance_of(TripletexApi::LedgercloseGroupApi)
    end
  end
