...
# Unit tests for TripletexApi::InvoiceApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvoiceApi' do
  before do
    # run before each test
    @instance = TripletexApi::InvoiceApi.new
  end
  ...
  describe 'test an instance of InvoiceApi' do
    it 'should create an instance of InvoiceApi' do
      expect(@instance).to be_instance_of(TripletexApi::InvoiceApi)
    end
  end
  ...
  # @param paid_amount Amount paid by customer
  # @param [Hash] opts the optional parameters
  # @return [ResponseWrapperInvoice]
