...
# Unit tests for TripletexApi::OrderorderlineApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderorderlineApi' do
  before do
    # run before each test
    @instance = TripletexApi::OrderorderlineApi.new
  end
  ...
  describe 'test an instance of OrderorderlineApi' do
    it 'should create an instance of OrderorderlineApi' do
      expect(@instance).to be_instance_of(TripletexApi::OrderorderlineApi)
    end
  end
