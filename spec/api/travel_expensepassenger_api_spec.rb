...
# Unit tests for TripletexApi::TravelExpensepassengerApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelExpensepassengerApi' do
  before do
    # run before each test
    @instance = TripletexApi::TravelExpensepassengerApi.new
  end
  ...
  describe 'test an instance of TravelExpensepassengerApi' do
    it 'should create an instance of TravelExpensepassengerApi' do
      expect(@instance).to be_instance_of(TripletexApi::TravelExpensepassengerApi)
    end
  end
