...
# Unit tests for TripletexApi::ProjectcategoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectcategoryApi' do
  before do
    # run before each test
    @instance = TripletexApi::ProjectcategoryApi.new
  end
  ...
  describe 'test an instance of ProjectcategoryApi' do
    it 'should create an instance of ProjectcategoryApi' do
      expect(@instance).to be_instance_of(TripletexApi::ProjectcategoryApi)
    end
  end
