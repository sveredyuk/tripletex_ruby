...
# Unit tests for TripletexApi::ProductexternalApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductexternalApi' do
  before do
    # run before each test
    @instance = TripletexApi::ProductexternalApi.new
  end
  ...
  describe 'test an instance of ProductexternalApi' do
    it 'should create an instance of ProductexternalApi' do
      expect(@instance).to be_instance_of(TripletexApi::ProductexternalApi)
    end
  end
