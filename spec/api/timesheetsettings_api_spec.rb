...
# Unit tests for TripletexApi::TimesheetsettingsApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimesheetsettingsApi' do
  before do
    # run before each test
    @instance = TripletexApi::TimesheetsettingsApi.new
  end
  ...
  describe 'test an instance of TimesheetsettingsApi' do
    it 'should create an instance of TimesheetsettingsApi' do
      expect(@instance).to be_instance_of(TripletexApi::TimesheetsettingsApi)
    end
  end
