...
# Unit tests for TripletexApi::TravelExpenseperDiemCompensationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelExpenseperDiemCompensationApi' do
  before do
    # run before each test
    @instance = TripletexApi::TravelExpenseperDiemCompensationApi.new
  end
  ...
  describe 'test an instance of TravelExpenseperDiemCompensationApi' do
    it 'should create an instance of TravelExpenseperDiemCompensationApi' do
      expect(@instance).to be_instance_of(TripletexApi::TravelExpenseperDiemCompensationApi)
    end
  end
