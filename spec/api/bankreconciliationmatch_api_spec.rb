...
# Unit tests for TripletexApi::BankreconciliationmatchApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankreconciliationmatchApi' do
  before do
    # run before each test
    @instance = TripletexApi::BankreconciliationmatchApi.new
  end
  ...
  describe 'test an instance of BankreconciliationmatchApi' do
    it 'should create an instance of BankreconciliationmatchApi' do
      expect(@instance).to be_instance_of(TripletexApi::BankreconciliationmatchApi)
    end
  end
