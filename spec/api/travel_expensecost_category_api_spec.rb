...
# Unit tests for TripletexApi::TravelExpensecostCategoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelExpensecostCategoryApi' do
  before do
    # run before each test
    @instance = TripletexApi::TravelExpensecostCategoryApi.new
  end
  ...
  describe 'test an instance of TravelExpensecostCategoryApi' do
    it 'should create an instance of TravelExpensecostCategoryApi' do
      expect(@instance).to be_instance_of(TripletexApi::TravelExpensecostCategoryApi)
    end
  end
