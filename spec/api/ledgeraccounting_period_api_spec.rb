...
# Unit tests for TripletexApi::LedgeraccountingPeriodApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LedgeraccountingPeriodApi' do
  before do
    # run before each test
    @instance = TripletexApi::LedgeraccountingPeriodApi.new
  end
  ...
  describe 'test an instance of LedgeraccountingPeriodApi' do
    it 'should create an instance of LedgeraccountingPeriodApi' do
      expect(@instance).to be_instance_of(TripletexApi::LedgeraccountingPeriodApi)
    end
  end
