...
# Unit tests for TripletexApi::CustomercategoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomercategoryApi' do
  before do
    # run before each test
    @instance = TripletexApi::CustomercategoryApi.new
  end
  ...
  describe 'test an instance of CustomercategoryApi' do
    it 'should create an instance of CustomercategoryApi' do
      expect(@instance).to be_instance_of(TripletexApi::CustomercategoryApi)
    end
  end
