...
# Unit tests for TripletexApi::LedgerpaymentTypeOutApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LedgerpaymentTypeOutApi' do
  before do
    # run before each test
    @instance = TripletexApi::LedgerpaymentTypeOutApi.new
  end
  ...
  describe 'test an instance of LedgerpaymentTypeOutApi' do
    it 'should create an instance of LedgerpaymentTypeOutApi' do
      expect(@instance).to be_instance_of(TripletexApi::LedgerpaymentTypeOutApi)
    end
  end
