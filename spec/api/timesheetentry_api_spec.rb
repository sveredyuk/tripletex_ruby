...
# Unit tests for TripletexApi::TimesheetentryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimesheetentryApi' do
  before do
    # run before each test
    @instance = TripletexApi::TimesheetentryApi.new
  end
  ...
  describe 'test an instance of TimesheetentryApi' do
    it 'should create an instance of TimesheetentryApi' do
      expect(@instance).to be_instance_of(TripletexApi::TimesheetentryApi)
    end
  end
