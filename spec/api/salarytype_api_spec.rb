...
# Unit tests for TripletexApi::SalarytypeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalarytypeApi' do
  before do
    # run before each test
    @instance = TripletexApi::SalarytypeApi.new
  end
  ...
  describe 'test an instance of SalarytypeApi' do
    it 'should create an instance of SalarytypeApi' do
      expect(@instance).to be_instance_of(TripletexApi::SalarytypeApi)
    end
  end
