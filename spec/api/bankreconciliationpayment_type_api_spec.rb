...
# Unit tests for TripletexApi::BankreconciliationpaymentTypeApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankreconciliationpaymentTypeApi' do
  before do
    # run before each test
    @instance = TripletexApi::BankreconciliationpaymentTypeApi.new
  end
  ...
  describe 'test an instance of BankreconciliationpaymentTypeApi' do
    it 'should create an instance of BankreconciliationpaymentTypeApi' do
      expect(@instance).to be_instance_of(TripletexApi::BankreconciliationpaymentTypeApi)
    end
  end
