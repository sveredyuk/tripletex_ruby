...
# Unit tests for TripletexApi::TravelExpenserateCategoryApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelExpenserateCategoryApi' do
  before do
    # run before each test
    @instance = TripletexApi::TravelExpenserateCategoryApi.new
  end
  ...
  describe 'test an instance of TravelExpenserateCategoryApi' do
    it 'should create an instance of TravelExpenserateCategoryApi' do
      expect(@instance).to be_instance_of(TripletexApi::TravelExpenserateCategoryApi)
    end
  end
