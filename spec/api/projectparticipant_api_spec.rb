...
# Unit tests for TripletexApi::ProjectparticipantApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectparticipantApi' do
  before do
    # run before each test
    @instance = TripletexApi::ProjectparticipantApi.new
  end
  ...
  describe 'test an instance of ProjectparticipantApi' do
    it 'should create an instance of ProjectparticipantApi' do
      expect(@instance).to be_instance_of(TripletexApi::ProjectparticipantApi)
    end
  end
