...
# Unit tests for TripletexApi::TimesheettimeClockApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimesheettimeClockApi' do
  before do
    # run before each test
    @instance = TripletexApi::TimesheettimeClockApi.new
  end
  ...
  describe 'test an instance of TimesheettimeClockApi' do
    it 'should create an instance of TimesheettimeClockApi' do
      expect(@instance).to be_instance_of(TripletexApi::TimesheettimeClockApi)
    end
  end
