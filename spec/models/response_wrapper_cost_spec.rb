...
# Unit tests for TripletexApi::ResponseWrapperCost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperCost' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperCost.new
  end
  ...
  describe 'test an instance of ResponseWrapperCost' do
    it 'should create an instance of ResponseWrapperCost' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperCost)
    end
  end
