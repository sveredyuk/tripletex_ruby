...
# Unit tests for TripletexApi::ResponseWrapperInteger
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperInteger' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperInteger.new
  end
  ...
  describe 'test an instance of ResponseWrapperInteger' do
    it 'should create an instance of ResponseWrapperInteger' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperInteger)
    end
  end
