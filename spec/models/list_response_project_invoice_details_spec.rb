...
# Unit tests for TripletexApi::ListResponseProjectInvoiceDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseProjectInvoiceDetails' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseProjectInvoiceDetails.new
  end
  ...
  describe 'test an instance of ListResponseProjectInvoiceDetails' do
    it 'should create an instance of ListResponseProjectInvoiceDetails' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseProjectInvoiceDetails)
    end
  end
