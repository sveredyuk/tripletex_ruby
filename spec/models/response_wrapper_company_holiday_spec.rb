...
# Unit tests for TripletexApi::ResponseWrapperCompanyHoliday
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperCompanyHoliday' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperCompanyHoliday.new
  end
  ...
  describe 'test an instance of ResponseWrapperCompanyHoliday' do
    it 'should create an instance of ResponseWrapperCompanyHoliday' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperCompanyHoliday)
    end
  end
