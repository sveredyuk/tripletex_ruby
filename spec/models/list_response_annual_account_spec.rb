...
# Unit tests for TripletexApi::ListResponseAnnualAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseAnnualAccount' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseAnnualAccount.new
  end
  ...
  describe 'test an instance of ListResponseAnnualAccount' do
    it 'should create an instance of ListResponseAnnualAccount' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseAnnualAccount)
    end
  end
