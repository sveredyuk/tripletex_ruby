...
# Unit tests for TripletexApi::ListResponseTravelExpense
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseTravelExpense' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseTravelExpense.new
  end
  ...
  describe 'test an instance of ListResponseTravelExpense' do
    it 'should create an instance of ListResponseTravelExpense' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseTravelExpense)
    end
  end
