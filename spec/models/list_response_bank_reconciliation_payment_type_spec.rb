...
# Unit tests for TripletexApi::ListResponseBankReconciliationPaymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseBankReconciliationPaymentType' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseBankReconciliationPaymentType.new
  end
  ...
  describe 'test an instance of ListResponseBankReconciliationPaymentType' do
    it 'should create an instance of ListResponseBankReconciliationPaymentType' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseBankReconciliationPaymentType)
    end
  end
