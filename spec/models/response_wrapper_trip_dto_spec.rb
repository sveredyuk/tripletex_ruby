...
# Unit tests for TripletexApi::ResponseWrapperTripDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperTripDTO' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperTripDTO.new
  end
  ...
  describe 'test an instance of ResponseWrapperTripDTO' do
    it 'should create an instance of ResponseWrapperTripDTO' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperTripDTO)
    end
  end
