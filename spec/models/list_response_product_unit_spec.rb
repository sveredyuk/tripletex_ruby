...
# Unit tests for TripletexApi::ListResponseProductUnit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseProductUnit' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseProductUnit.new
  end
  ...
  describe 'test an instance of ListResponseProductUnit' do
    it 'should create an instance of ListResponseProductUnit' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseProductUnit)
    end
  end
