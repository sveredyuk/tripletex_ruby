...
# Unit tests for TripletexApi::TravelPaymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelPaymentType' do
  before do
    # run before each test
    @instance = TripletexApi::TravelPaymentType.new
  end
  ...
  describe 'test an instance of TravelPaymentType' do
    it 'should create an instance of TravelPaymentType' do
      expect(@instance).to be_instance_of(TripletexApi::TravelPaymentType)
    end
  end
