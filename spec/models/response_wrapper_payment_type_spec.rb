...
# Unit tests for TripletexApi::ResponseWrapperPaymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperPaymentType' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperPaymentType.new
  end
  ...
  describe 'test an instance of ResponseWrapperPaymentType' do
    it 'should create an instance of ResponseWrapperPaymentType' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperPaymentType)
    end
  end
