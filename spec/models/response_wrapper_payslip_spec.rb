...
# Unit tests for TripletexApi::ResponseWrapperPayslip
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperPayslip' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperPayslip.new
  end
  ...
  describe 'test an instance of ResponseWrapperPayslip' do
    it 'should create an instance of ResponseWrapperPayslip' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperPayslip)
    end
  end
