...
# Unit tests for TripletexApi::MonthlyStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MonthlyStatus' do
  before do
    # run before each test
    @instance = TripletexApi::MonthlyStatus.new
  end
  ...
  describe 'test an instance of MonthlyStatus' do
    it 'should create an instance of MonthlyStatus' do
      expect(@instance).to be_instance_of(TripletexApi::MonthlyStatus)
    end
  end
  ...
  describe 'test attribute "hours_paid"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "vacation_transferred"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "wage_payment"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
