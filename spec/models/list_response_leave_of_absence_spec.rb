...
# Unit tests for TripletexApi::ListResponseLeaveOfAbsence
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseLeaveOfAbsence' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseLeaveOfAbsence.new
  end
  ...
  describe 'test an instance of ListResponseLeaveOfAbsence' do
    it 'should create an instance of ListResponseLeaveOfAbsence' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseLeaveOfAbsence)
    end
  end
