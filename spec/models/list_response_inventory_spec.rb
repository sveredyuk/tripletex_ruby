...
# Unit tests for TripletexApi::ListResponseInventory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseInventory' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseInventory.new
  end
  ...
  describe 'test an instance of ListResponseInventory' do
    it 'should create an instance of ListResponseInventory' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseInventory)
    end
  end
