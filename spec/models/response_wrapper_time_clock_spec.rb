...
# Unit tests for TripletexApi::ResponseWrapperTimeClock
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperTimeClock' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperTimeClock.new
  end
  ...
  describe 'test an instance of ResponseWrapperTimeClock' do
    it 'should create an instance of ResponseWrapperTimeClock' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperTimeClock)
    end
  end
