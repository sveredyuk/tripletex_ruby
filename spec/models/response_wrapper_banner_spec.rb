...
# Unit tests for TripletexApi::ResponseWrapperBanner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperBanner' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperBanner.new
  end
  ...
  describe 'test an instance of ResponseWrapperBanner' do
    it 'should create an instance of ResponseWrapperBanner' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperBanner)
    end
  end
