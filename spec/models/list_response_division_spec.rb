...
# Unit tests for TripletexApi::ListResponseDivision
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseDivision' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseDivision.new
  end
  ...
  describe 'test an instance of ListResponseDivision' do
    it 'should create an instance of ListResponseDivision' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseDivision)
    end
  end
