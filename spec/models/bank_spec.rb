...
# Unit tests for TripletexApi::Bank
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Bank' do
  before do
    # run before each test
    @instance = TripletexApi::Bank.new
  end
  ...
  describe 'test an instance of Bank' do
    it 'should create an instance of Bank' do
      expect(@instance).to be_instance_of(TripletexApi::Bank)
    end
  end
  ...
  describe 'test attribute "bank_statement_file_format_support"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["DNB_CSV", "EIKA_TELEPAY", "SPAREBANK1_TELEPAY", "VISMA_ACCOUNT_STATEMENT", "DANSKE_BANK_CSV"])
