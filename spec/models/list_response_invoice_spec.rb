...
# Unit tests for TripletexApi::ListResponseInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseInvoice' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseInvoice.new
  end
  ...
  describe 'test an instance of ListResponseInvoice' do
    it 'should create an instance of ListResponseInvoice' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseInvoice)
    end
  end
