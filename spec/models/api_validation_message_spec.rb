...
# Unit tests for TripletexApi::ApiValidationMessage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiValidationMessage' do
  before do
    # run before each test
    @instance = TripletexApi::ApiValidationMessage.new
  end
  ...
  describe 'test an instance of ApiValidationMessage' do
    it 'should create an instance of ApiValidationMessage' do
      expect(@instance).to be_instance_of(TripletexApi::ApiValidationMessage)
    end
  end
