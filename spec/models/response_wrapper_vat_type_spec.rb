...
# Unit tests for TripletexApi::ResponseWrapperVatType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperVatType' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperVatType.new
  end
  ...
  describe 'test an instance of ResponseWrapperVatType' do
    it 'should create an instance of ResponseWrapperVatType' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperVatType)
    end
  end
