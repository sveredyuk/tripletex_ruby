...
# Unit tests for TripletexApi::ListResponseCloseGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCloseGroup' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCloseGroup.new
  end
  ...
  describe 'test an instance of ListResponseCloseGroup' do
    it 'should create an instance of ListResponseCloseGroup' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCloseGroup)
    end
  end
