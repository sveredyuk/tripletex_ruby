...
# Unit tests for TripletexApi::ResponseWrapperCustomer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperCustomer' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperCustomer.new
  end
  ...
  describe 'test an instance of ResponseWrapperCustomer' do
    it 'should create an instance of ResponseWrapperCustomer' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperCustomer)
    end
  end
