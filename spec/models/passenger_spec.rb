...
# Unit tests for TripletexApi::Passenger
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Passenger' do
  before do
    # run before each test
    @instance = TripletexApi::Passenger.new
  end
  ...
  describe 'test an instance of Passenger' do
    it 'should create an instance of Passenger' do
      expect(@instance).to be_instance_of(TripletexApi::Passenger)
    end
  end
  ...
  describe 'test attribute "mileage_allowance"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
