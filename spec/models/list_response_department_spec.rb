...
# Unit tests for TripletexApi::ListResponseDepartment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseDepartment' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseDepartment.new
  end
  ...
  describe 'test an instance of ListResponseDepartment' do
    it 'should create an instance of ListResponseDepartment' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseDepartment)
    end
  end
