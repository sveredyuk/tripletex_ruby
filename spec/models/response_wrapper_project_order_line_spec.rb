...
# Unit tests for TripletexApi::ResponseWrapperProjectOrderLine
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperProjectOrderLine' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperProjectOrderLine.new
  end
  ...
  describe 'test an instance of ResponseWrapperProjectOrderLine' do
    it 'should create an instance of ResponseWrapperProjectOrderLine' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperProjectOrderLine)
    end
  end
