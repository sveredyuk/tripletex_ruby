...
# Unit tests for TripletexApi::ResponseWrapperSalarySettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperSalarySettings' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperSalarySettings.new
  end
  ...
  describe 'test an instance of ResponseWrapperSalarySettings' do
    it 'should create an instance of ResponseWrapperSalarySettings' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperSalarySettings)
    end
  end
