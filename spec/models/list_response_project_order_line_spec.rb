...
# Unit tests for TripletexApi::ListResponseProjectOrderLine
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseProjectOrderLine' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseProjectOrderLine.new
  end
  ...
  describe 'test an instance of ListResponseProjectOrderLine' do
    it 'should create an instance of ListResponseProjectOrderLine' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseProjectOrderLine)
    end
  end
