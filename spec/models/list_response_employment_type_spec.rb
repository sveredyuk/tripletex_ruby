...
# Unit tests for TripletexApi::ListResponseEmploymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseEmploymentType' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseEmploymentType.new
  end
  ...
  describe 'test an instance of ListResponseEmploymentType' do
    it 'should create an instance of ListResponseEmploymentType' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseEmploymentType)
    end
  end
