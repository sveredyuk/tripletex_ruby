...
# Unit tests for TripletexApi::ResponseWrapperApiConsumer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperApiConsumer' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperApiConsumer.new
  end
  ...
  describe 'test an instance of ResponseWrapperApiConsumer' do
    it 'should create an instance of ResponseWrapperApiConsumer' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperApiConsumer)
    end
  end
