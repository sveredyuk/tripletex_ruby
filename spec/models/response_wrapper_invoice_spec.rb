...
# Unit tests for TripletexApi::ResponseWrapperInvoice
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperInvoice' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperInvoice.new
  end
  ...
  describe 'test an instance of ResponseWrapperInvoice' do
    it 'should create an instance of ResponseWrapperInvoice' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperInvoice)
    end
  end
