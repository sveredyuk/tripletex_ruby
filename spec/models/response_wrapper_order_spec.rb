...
# Unit tests for TripletexApi::ResponseWrapperOrder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperOrder' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperOrder.new
  end
  ...
  describe 'test an instance of ResponseWrapperOrder' do
    it 'should create an instance of ResponseWrapperOrder' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperOrder)
    end
  end
