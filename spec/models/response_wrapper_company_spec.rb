...
# Unit tests for TripletexApi::ResponseWrapperCompany
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperCompany' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperCompany.new
  end
  ...
  describe 'test an instance of ResponseWrapperCompany' do
    it 'should create an instance of ResponseWrapperCompany' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperCompany)
    end
  end
