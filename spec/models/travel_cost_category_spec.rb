...
# Unit tests for TripletexApi::TravelCostCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelCostCategory' do
  before do
    # run before each test
    @instance = TripletexApi::TravelCostCategory.new
  end
  ...
  describe 'test an instance of TravelCostCategory' do
    it 'should create an instance of TravelCostCategory' do
      expect(@instance).to be_instance_of(TripletexApi::TravelCostCategory)
    end
  end
