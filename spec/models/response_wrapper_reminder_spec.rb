...
# Unit tests for TripletexApi::ResponseWrapperReminder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperReminder' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperReminder.new
  end
  ...
  describe 'test an instance of ResponseWrapperReminder' do
    it 'should create an instance of ResponseWrapperReminder' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperReminder)
    end
  end
