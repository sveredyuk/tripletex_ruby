...
# Unit tests for TripletexApi::ListResponsePassenger
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponsePassenger' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponsePassenger.new
  end
  ...
  describe 'test an instance of ListResponsePassenger' do
    it 'should create an instance of ListResponsePassenger' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponsePassenger)
    end
  end
