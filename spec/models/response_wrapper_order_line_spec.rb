...
# Unit tests for TripletexApi::ResponseWrapperOrderLine
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperOrderLine' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperOrderLine.new
  end
  ...
  describe 'test an instance of ResponseWrapperOrderLine' do
    it 'should create an instance of ResponseWrapperOrderLine' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperOrderLine)
    end
  end
