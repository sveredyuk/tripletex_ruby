...
# Unit tests for TripletexApi::ListResponseVoucher
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseVoucher' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseVoucher.new
  end
  ...
  describe 'test an instance of ListResponseVoucher' do
    it 'should create an instance of ListResponseVoucher' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseVoucher)
    end
  end
