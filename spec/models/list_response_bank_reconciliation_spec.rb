...
# Unit tests for TripletexApi::ListResponseBankReconciliation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseBankReconciliation' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseBankReconciliation.new
  end
  ...
  describe 'test an instance of ListResponseBankReconciliation' do
    it 'should create an instance of ListResponseBankReconciliation' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseBankReconciliation)
    end
  end
