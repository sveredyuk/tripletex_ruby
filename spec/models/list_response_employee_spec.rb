...
# Unit tests for TripletexApi::ListResponseEmployee
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseEmployee' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseEmployee.new
  end
  ...
  describe 'test an instance of ListResponseEmployee' do
    it 'should create an instance of ListResponseEmployee' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseEmployee)
    end
  end
