...
# Unit tests for TripletexApi::ProjectParticipant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectParticipant' do
  before do
    # run before each test
    @instance = TripletexApi::ProjectParticipant.new
  end
  ...
  describe 'test an instance of ProjectParticipant' do
    it 'should create an instance of ProjectParticipant' do
      expect(@instance).to be_instance_of(TripletexApi::ProjectParticipant)
    end
  end
