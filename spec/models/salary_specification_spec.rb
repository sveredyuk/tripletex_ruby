...
# Unit tests for TripletexApi::SalarySpecification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalarySpecification' do
  before do
    # run before each test
    @instance = TripletexApi::SalarySpecification.new
  end
  ...
  describe 'test an instance of SalarySpecification' do
    it 'should create an instance of SalarySpecification' do
      expect(@instance).to be_instance_of(TripletexApi::SalarySpecification)
    end
  end
