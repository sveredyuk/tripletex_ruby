...
# Unit tests for TripletexApi::ResponseWrapperWeeklyStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperWeeklyStatus' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperWeeklyStatus.new
  end
  ...
  describe 'test an instance of ResponseWrapperWeeklyStatus' do
    it 'should create an instance of ResponseWrapperWeeklyStatus' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperWeeklyStatus)
    end
  end
