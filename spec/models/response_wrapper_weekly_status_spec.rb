...
# Unit tests for TripletexApi::ResponseWrapperWeek
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperWeek' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperWeek.new
  end
  ...
  describe 'test an instance of ResponseWrapperWeek' do
    it 'should create an instance of ResponseWrapperWeek' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperWeek)
    end
  end
