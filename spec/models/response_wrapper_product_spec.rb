...
# Unit tests for TripletexApi::ResponseWrapperProduct
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperProduct' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperProduct.new
  end
  ...
  describe 'test an instance of ResponseWrapperProduct' do
    it 'should create an instance of ResponseWrapperProduct' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperProduct)
    end
  end
