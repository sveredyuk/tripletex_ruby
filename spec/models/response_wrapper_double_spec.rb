...
# Unit tests for TripletexApi::ResponseWrapperDouble
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperDouble' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperDouble.new
  end
  ...
  describe 'test an instance of ResponseWrapperDouble' do
    it 'should create an instance of ResponseWrapperDouble' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperDouble)
    end
  end
