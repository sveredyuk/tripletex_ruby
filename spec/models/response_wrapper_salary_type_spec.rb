...
# Unit tests for TripletexApi::ResponseWrapperSalaryType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperSalaryType' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperSalaryType.new
  end
  ...
  describe 'test an instance of ResponseWrapperSalaryType' do
    it 'should create an instance of ResponseWrapperSalaryType' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperSalaryType)
    end
  end
