...
# Unit tests for TripletexApi::JobDetailDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'JobDetailDTO' do
  before do
    # run before each test
    @instance = TripletexApi::JobDetailDTO.new
  end
  ...
  describe 'test an instance of JobDetailDTO' do
    it 'should create an instance of JobDetailDTO' do
      expect(@instance).to be_instance_of(TripletexApi::JobDetailDTO)
    end
  end
  ...
  describe 'test attribute "jobclass"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
