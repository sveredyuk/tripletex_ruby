...
# Unit tests for TripletexApi::TimesheetSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimesheetSettings' do
  before do
    # run before each test
    @instance = TripletexApi::TimesheetSettings.new
  end
  ...
  describe 'test an instance of TimesheetSettings' do
    it 'should create an instance of TimesheetSettings' do
      expect(@instance).to be_instance_of(TripletexApi::TimesheetSettings)
    end
  end
  ...
  describe 'test attribute "time_clock"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "timesheet_completed"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
