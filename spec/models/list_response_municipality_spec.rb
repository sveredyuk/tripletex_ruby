...
# Unit tests for TripletexApi::ListResponseMunicipality
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseMunicipality' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseMunicipality.new
  end
  ...
  describe 'test an instance of ListResponseMunicipality' do
    it 'should create an instance of ListResponseMunicipality' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseMunicipality)
    end
  end
