...
# Unit tests for TripletexApi::ListResponseBankReconciliationMatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseBankReconciliationMatch' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseBankReconciliationMatch.new
  end
  ...
  describe 'test an instance of ListResponseBankReconciliationMatch' do
    it 'should create an instance of ListResponseBankReconciliationMatch' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseBankReconciliationMatch)
    end
  end
