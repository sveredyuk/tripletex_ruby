...
# Unit tests for TripletexApi::EmployeeToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmployeeToken' do
  before do
    # run before each test
    @instance = TripletexApi::EmployeeToken.new
  end
  ...
  describe 'test an instance of EmployeeToken' do
    it 'should create an instance of EmployeeToken' do
      expect(@instance).to be_instance_of(TripletexApi::EmployeeToken)
    end
  end
