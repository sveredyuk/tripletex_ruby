...
# Unit tests for TripletexApi::ResponseWrapperAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperAccount' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperAccount.new
  end
  ...
  describe 'test an instance of ResponseWrapperAccount' do
    it 'should create an instance of ResponseWrapperAccount' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperAccount)
    end
  end
