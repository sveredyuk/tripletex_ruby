...
# Unit tests for TripletexApi::ResponseWrapperSystemMessage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperSystemMessage' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperSystemMessage.new
  end
  ...
  describe 'test an instance of ResponseWrapperSystemMessage' do
    it 'should create an instance of ResponseWrapperSystemMessage' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperSystemMessage)
    end
  end
