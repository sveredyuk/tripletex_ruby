...
# Unit tests for TripletexApi::ListResponseWeeklyStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseWeeklyStatus' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseWeeklyStatus.new
  end
  ...
  describe 'test an instance of ListResponseWeeklyStatus' do
    it 'should create an instance of ListResponseWeeklyStatus' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseWeeklyStatus)
    end
  end
