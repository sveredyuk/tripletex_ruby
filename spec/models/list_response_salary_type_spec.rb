...
# Unit tests for TripletexApi::ListResponseSalaryType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseSalaryType' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseSalaryType.new
  end
  ...
  describe 'test an instance of ListResponseSalaryType' do
    it 'should create an instance of ListResponseSalaryType' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseSalaryType)
    end
  end
