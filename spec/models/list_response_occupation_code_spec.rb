...
# Unit tests for TripletexApi::ListResponseOccupationCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseOccupationCode' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseOccupationCode.new
  end
  ...
  describe 'test an instance of ListResponseOccupationCode' do
    it 'should create an instance of ListResponseOccupationCode' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseOccupationCode)
    end
  end
