...
# Unit tests for TripletexApi::CSVRecord
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CSVRecord' do
  before do
    # run before each test
    @instance = TripletexApi::CSVRecord.new
  end
  ...
  describe 'test an instance of CSVRecord' do
    it 'should create an instance of CSVRecord' do
      expect(@instance).to be_instance_of(TripletexApi::CSVRecord)
    end
  end
  ...
  describe 'test attribute "record_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "consistent"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
