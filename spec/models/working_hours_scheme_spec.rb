...
# Unit tests for TripletexApi::WorkingHoursScheme
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WorkingHoursScheme' do
  before do
    # run before each test
    @instance = TripletexApi::WorkingHoursScheme.new
  end
  ...
  describe 'test an instance of WorkingHoursScheme' do
    it 'should create an instance of WorkingHoursScheme' do
      expect(@instance).to be_instance_of(TripletexApi::WorkingHoursScheme)
    end
  end
  ...
  describe 'test attribute "working_hours_scheme"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["NOT_SHIFT", "ROUND_THE_CLOCK", "SHIFT_365", "OFFSHORE_336", "CONTINUOUS"])
