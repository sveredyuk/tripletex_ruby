...
# Unit tests for TripletexApi::ResponseWrapperProductUnit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperProductUnit' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperProductUnit.new
  end
  ...
  describe 'test an instance of ResponseWrapperProductUnit' do
    it 'should create an instance of ResponseWrapperProductUnit' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperProductUnit)
    end
  end
