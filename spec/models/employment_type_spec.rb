...
# Unit tests for TripletexApi::EmploymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmploymentType' do
  before do
    # run before each test
    @instance = TripletexApi::EmploymentType.new
  end
  ...
  describe 'test an instance of EmploymentType' do
    it 'should create an instance of EmploymentType' do
      expect(@instance).to be_instance_of(TripletexApi::EmploymentType)
    end
  end
  ...
  describe 'test attribute "employment_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["TYPE_OF_EMPLOYMENT_RELATIONSHIP"])
