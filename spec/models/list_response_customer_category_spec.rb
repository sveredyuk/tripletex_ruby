...
# Unit tests for TripletexApi::ListResponseCustomerCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCustomerCategory' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCustomerCategory.new
  end
  ...
  describe 'test an instance of ListResponseCustomerCategory' do
    it 'should create an instance of ListResponseCustomerCategory' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCustomerCategory)
    end
  end
