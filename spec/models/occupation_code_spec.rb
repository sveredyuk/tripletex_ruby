...
# Unit tests for TripletexApi::OccupationCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OccupationCode' do
  before do
    # run before each test
    @instance = TripletexApi::OccupationCode.new
  end
  ...
  describe 'test an instance of OccupationCode' do
    it 'should create an instance of OccupationCode' do
      expect(@instance).to be_instance_of(TripletexApi::OccupationCode)
    end
  end
