...
# Unit tests for TripletexApi::ResponseWrapperSupplier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperSupplier' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperSupplier.new
  end
  ...
  describe 'test an instance of ResponseWrapperSupplier' do
    it 'should create an instance of ResponseWrapperSupplier' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperSupplier)
    end
  end
