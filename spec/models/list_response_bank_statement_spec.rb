...
# Unit tests for TripletexApi::ListResponseBankStatement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseBankStatement' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseBankStatement.new
  end
  ...
  describe 'test an instance of ListResponseBankStatement' do
    it 'should create an instance of ListResponseBankStatement' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseBankStatement)
    end
  end
