...
# Unit tests for TripletexApi::TriggerDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TriggerDTO' do
  before do
    # run before each test
    @instance = TripletexApi::TriggerDTO.new
  end
  ...
  describe 'test an instance of TriggerDTO' do
    it 'should create an instance of TriggerDTO' do
      expect(@instance).to be_instance_of(TripletexApi::TriggerDTO)
    end
  end
  describe 'test attribute "calendar_name"' do
    it 'should work' do
  ...
  describe 'test attribute "previous_fire_time"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
