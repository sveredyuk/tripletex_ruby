...
# Unit tests for TripletexApi::ListResponseContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseContact' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseContact.new
  end
  ...
  describe 'test an instance of ListResponseContact' do
    it 'should create an instance of ListResponseContact' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseContact)
    end
  end
