...
# Unit tests for TripletexApi::EventInfoDescription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventInfoDescription' do
  before do
    # run before each test
    @instance = TripletexApi::EventInfoDescription.new
  end
  ...
  describe 'test an instance of EventInfoDescription' do
    it 'should create an instance of EventInfoDescription' do
      expect(@instance).to be_instance_of(TripletexApi::EventInfoDescription)
    end
  end
