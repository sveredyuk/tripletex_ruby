...
# Unit tests for TripletexApi::ResponseWrapperBoolean
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperBoolean' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperBoolean.new
  end
  ...
  describe 'test an instance of ResponseWrapperBoolean' do
    it 'should create an instance of ResponseWrapperBoolean' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperBoolean)
    end
  end
