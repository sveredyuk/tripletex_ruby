...
# Unit tests for TripletexApi::ListResponseCompanyAutoCompleteDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCompanyAutoCompleteDTO' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCompanyAutoCompleteDTO.new
  end
  ...
  describe 'test an instance of ListResponseCompanyAutoCompleteDTO' do
    it 'should create an instance of ListResponseCompanyAutoCompleteDTO' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCompanyAutoCompleteDTO)
    end
  end
