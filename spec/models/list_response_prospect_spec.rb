...
# Unit tests for TripletexApi::ListResponseProspect
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseProspect' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseProspect.new
  end
  ...
  describe 'test an instance of ListResponseProspect' do
    it 'should create an instance of ListResponseProspect' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseProspect)
    end
  end
