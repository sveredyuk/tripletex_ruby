...
# Unit tests for TripletexApi::ResponseWrapperSessionToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperSessionToken' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperSessionToken.new
  end
  ...
  describe 'test an instance of ResponseWrapperSessionToken' do
    it 'should create an instance of ResponseWrapperSessionToken' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperSessionToken)
    end
  end
