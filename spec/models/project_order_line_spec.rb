...
# Unit tests for TripletexApi::ProjectOrderLine
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectOrderLine' do
  before do
    # run before each test
    @instance = TripletexApi::ProjectOrderLine.new
  end
  ...
  describe 'test an instance of ProjectOrderLine' do
    it 'should create an instance of ProjectOrderLine' do
      expect(@instance).to be_instance_of(TripletexApi::ProjectOrderLine)
    end
  end
