...
# Unit tests for TripletexApi::VoucherType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VoucherType' do
  before do
    # run before each test
    @instance = TripletexApi::VoucherType.new
  end
  ...
  describe 'test an instance of VoucherType' do
    it 'should create an instance of VoucherType' do
      expect(@instance).to be_instance_of(TripletexApi::VoucherType)
    end
  end
