...
# Unit tests for TripletexApi::ResponseWrapperNextOfKin
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperNextOfKin' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperNextOfKin.new
  end
  ...
  describe 'test an instance of ResponseWrapperNextOfKin' do
    it 'should create an instance of ResponseWrapperNextOfKin' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperNextOfKin)
    end
  end
