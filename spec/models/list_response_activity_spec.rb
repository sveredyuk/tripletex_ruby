...
# Unit tests for TripletexApi::ListResponseActivity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseActivity' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseActivity.new
  end
  ...
  describe 'test an instance of ListResponseActivity' do
    it 'should create an instance of ListResponseActivity' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseActivity)
    end
  end
