...
# Unit tests for TripletexApi::CustomerCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomerCategory' do
  before do
    # run before each test
    @instance = TripletexApi::CustomerCategory.new
  end
  ...
  describe 'test an instance of CustomerCategory' do
    it 'should create an instance of CustomerCategory' do
      expect(@instance).to be_instance_of(TripletexApi::CustomerCategory)
    end
  end
