...
# Unit tests for TripletexApi::ResponseWrapperStandardTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperStandardTime' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperStandardTime.new
  end
  ...
  describe 'test an instance of ResponseWrapperStandardTime' do
    it 'should create an instance of ResponseWrapperStandardTime' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperStandardTime)
    end
  end
