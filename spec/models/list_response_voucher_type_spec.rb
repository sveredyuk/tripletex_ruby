...
# Unit tests for TripletexApi::ListResponseVoucherType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseVoucherType' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseVoucherType.new
  end
  ...
  describe 'test an instance of ListResponseVoucherType' do
    it 'should create an instance of ListResponseVoucherType' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseVoucherType)
    end
  end
