...
# Unit tests for TripletexApi::TravelExpenseRate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TravelExpenseRate' do
  before do
    # run before each test
    @instance = TripletexApi::TravelExpenseRate.new
  end
  ...
  describe 'test an instance of TravelExpenseRate' do
    it 'should create an instance of TravelExpenseRate' do
      expect(@instance).to be_instance_of(TripletexApi::TravelExpenseRate)
    end
  end
