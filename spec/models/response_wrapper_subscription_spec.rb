...
# Unit tests for TripletexApi::ResponseWrapperSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperSubscription' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperSubscription.new
  end
  ...
  describe 'test an instance of ResponseWrapperSubscription' do
    it 'should create an instance of ResponseWrapperSubscription' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperSubscription)
    end
  end
