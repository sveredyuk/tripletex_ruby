...
# Unit tests for TripletexApi::ListResponsePaymentType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponsePaymentType' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponsePaymentType.new
  end
  ...
  describe 'test an instance of ListResponsePaymentType' do
    it 'should create an instance of ListResponsePaymentType' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponsePaymentType)
    end
  end
