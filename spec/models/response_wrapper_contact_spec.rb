...
# Unit tests for TripletexApi::ResponseWrapperContact
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperContact' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperContact.new
  end
  ...
  describe 'test an instance of ResponseWrapperContact' do
    it 'should create an instance of ResponseWrapperContact' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperContact)
    end
  end
