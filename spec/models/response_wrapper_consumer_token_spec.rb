...
# Unit tests for TripletexApi::ResponseWrapperConsumerToken
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperConsumerToken' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperConsumerToken.new
  end
  ...
  describe 'test an instance of ResponseWrapperConsumerToken' do
    it 'should create an instance of ResponseWrapperConsumerToken' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperConsumerToken)
    end
  end
