...
# Unit tests for TripletexApi::ListResponseSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseSubscription' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseSubscription.new
  end
  ...
  describe 'test an instance of ListResponseSubscription' do
    it 'should create an instance of ListResponseSubscription' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseSubscription)
    end
  end
