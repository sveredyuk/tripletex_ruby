...
# Unit tests for TripletexApi::ResponseWrapperPosting
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperPosting' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperPosting.new
  end
  ...
  describe 'test an instance of ResponseWrapperPosting' do
    it 'should create an instance of ResponseWrapperPosting' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperPosting)
    end
  end
