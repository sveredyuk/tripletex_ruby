...
# Unit tests for TripletexApi::Voucher
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Voucher' do
  before do
    # run before each test
    @instance = TripletexApi::Voucher.new
  end
  ...
  describe 'test an instance of Voucher' do
    it 'should create an instance of Voucher' do
      expect(@instance).to be_instance_of(TripletexApi::Voucher)
    end
  end
  ...
  describe 'test attribute "reverse_voucher"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
