...
# Unit tests for TripletexApi::ResponseWrapperVoucher
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperVoucher' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperVoucher.new
  end
  ...
  describe 'test an instance of ResponseWrapperVoucher' do
    it 'should create an instance of ResponseWrapperVoucher' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperVoucher)
    end
  end
