...
# Unit tests for TripletexApi::ListResponseBankTransaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseBankTransaction' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseBankTransaction.new
  end
  ...
  describe 'test an instance of ListResponseBankTransaction' do
    it 'should create an instance of ListResponseBankTransaction' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseBankTransaction)
    end
  end
