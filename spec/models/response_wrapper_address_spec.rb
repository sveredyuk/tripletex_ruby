...
# Unit tests for TripletexApi::ResponseWrapperAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperAddress' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperAddress.new
  end
  ...
  describe 'test an instance of ResponseWrapperAddress' do
    it 'should create an instance of ResponseWrapperAddress' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperAddress)
    end
  end
