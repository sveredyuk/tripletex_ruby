...
# Unit tests for TripletexApi::ListResponseCustomer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCustomer' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCustomer.new
  end
  ...
  describe 'test an instance of ListResponseCustomer' do
    it 'should create an instance of ListResponseCustomer' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCustomer)
    end
  end
