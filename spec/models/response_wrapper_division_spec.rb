...
# Unit tests for TripletexApi::ResponseWrapperDivision
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperDivision' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperDivision.new
  end
  ...
  describe 'test an instance of ResponseWrapperDivision' do
    it 'should create an instance of ResponseWrapperDivision' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperDivision)
    end
  end
