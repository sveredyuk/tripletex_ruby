...
# Unit tests for TripletexApi::ListResponseTimesheetEntry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseTimesheetEntry' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseTimesheetEntry.new
  end
  ...
  describe 'test an instance of ListResponseTimesheetEntry' do
    it 'should create an instance of ListResponseTimesheetEntry' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseTimesheetEntry)
    end
  end
