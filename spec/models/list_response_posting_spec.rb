...
# Unit tests for TripletexApi::ListResponsePosting
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponsePosting' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponsePosting.new
  end
  ...
  describe 'test an instance of ListResponsePosting' do
    it 'should create an instance of ListResponsePosting' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponsePosting)
    end
  end
