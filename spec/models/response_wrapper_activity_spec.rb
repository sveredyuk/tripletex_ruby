...
# Unit tests for TripletexApi::ResponseWrapperActivity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperActivity' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperActivity.new
  end
  ...
  describe 'test an instance of ResponseWrapperActivity' do
    it 'should create an instance of ResponseWrapperActivity' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperActivity)
    end
  end
