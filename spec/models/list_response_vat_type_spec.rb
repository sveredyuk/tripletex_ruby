...
# Unit tests for TripletexApi::ListResponseVatType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseVatType' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseVatType.new
  end
  ...
  describe 'test an instance of ListResponseVatType' do
    it 'should create an instance of ListResponseVatType' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseVatType)
    end
  end
