...
# Unit tests for TripletexApi::ImportConfigDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ImportConfigDTO' do
  before do
    # run before each test
    @instance = TripletexApi::ImportConfigDTO.new
  end
  ...
  describe 'test an instance of ImportConfigDTO' do
    it 'should create an instance of ImportConfigDTO' do
      expect(@instance).to be_instance_of(TripletexApi::ImportConfigDTO)
    end
  end
  describe 'test attribute "only_users"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "skip_users"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "skip_accounts"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
