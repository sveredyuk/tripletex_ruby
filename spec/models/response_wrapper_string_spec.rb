...
# Unit tests for TripletexApi::ResponseWrapperString
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperString' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperString.new
  end
  ...
  describe 'test an instance of ResponseWrapperString' do
    it 'should create an instance of ResponseWrapperString' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperString)
    end
  end
