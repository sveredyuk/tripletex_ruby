...
# Unit tests for TripletexApi::ListResponseOrderOffer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseOrderOffer' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseOrderOffer.new
  end
  ...
  describe 'test an instance of ListResponseOrderOffer' do
    it 'should create an instance of ListResponseOrderOffer' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseOrderOffer)
    end
  end
