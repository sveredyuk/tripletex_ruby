...
# Unit tests for TripletexApi::ResponseWrapperEmployment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperEmployment' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperEmployment.new
  end
  ...
  describe 'test an instance of ResponseWrapperEmployment' do
    it 'should create an instance of ResponseWrapperEmployment' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperEmployment)
    end
  end
