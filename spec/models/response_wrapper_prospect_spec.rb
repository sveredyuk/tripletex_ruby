...
# Unit tests for TripletexApi::ResponseWrapperProspect
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperProspect' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperProspect.new
  end
  ...
  describe 'test an instance of ResponseWrapperProspect' do
    it 'should create an instance of ResponseWrapperProspect' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperProspect)
    end
  end
