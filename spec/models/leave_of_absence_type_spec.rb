...
# Unit tests for TripletexApi::LeaveOfAbsenceType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LeaveOfAbsenceType' do
  before do
    # run before each test
    @instance = TripletexApi::LeaveOfAbsenceType.new
  end
  ...
  describe 'test an instance of LeaveOfAbsenceType' do
    it 'should create an instance of LeaveOfAbsenceType' do
      expect(@instance).to be_instance_of(TripletexApi::LeaveOfAbsenceType)
    end
  end
  ...
  describe 'test attribute "leave_of_absence_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["FURLOUGH", "SALARY_TYPE", "PARENTAL_BENEFITS", "EDUCATIONAL", "COMPASSIONATE"])
