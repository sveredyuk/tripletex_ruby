...
# Unit tests for TripletexApi::MobileAppLogin
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MobileAppLogin' do
  before do
    # run before each test
    @instance = TripletexApi::MobileAppLogin.new
  end
  ...
  describe 'test an instance of MobileAppLogin' do
    it 'should create an instance of MobileAppLogin' do
      expect(@instance).to be_instance_of(TripletexApi::MobileAppLogin)
    end
  end
