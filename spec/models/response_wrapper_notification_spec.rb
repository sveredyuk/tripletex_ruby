...
# Unit tests for TripletexApi::ResponseWrapperNotification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperNotification' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperNotification.new
  end
  ...
  describe 'test an instance of ResponseWrapperNotification' do
    it 'should create an instance of ResponseWrapperNotification' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperNotification)
    end
  end
