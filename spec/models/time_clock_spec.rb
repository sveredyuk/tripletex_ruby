...
# Unit tests for TripletexApi::TimeClock
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TimeClock' do
  before do
    # run before each test
    @instance = TripletexApi::TimeClock.new
  end
  ...
  describe 'test an instance of TimeClock' do
    it 'should create an instance of TimeClock' do
      expect(@instance).to be_instance_of(TripletexApi::TimeClock)
    end
  end
  ...
  describe 'test attribute "time_stop"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "hours_start"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
