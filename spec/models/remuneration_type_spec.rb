...
# Unit tests for TripletexApi::RemunerationType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RemunerationType' do
  before do
    # run before each test
    @instance = TripletexApi::RemunerationType.new
  end
  ...
  describe 'test an instance of RemunerationType' do
    it 'should create an instance of RemunerationType' do
      expect(@instance).to be_instance_of(TripletexApi::RemunerationType)
    end
  end
  ...
  describe 'test attribute "remuneration_type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["REMUNERATION_TYPE"])
