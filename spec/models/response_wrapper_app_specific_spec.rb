...
# Unit tests for TripletexApi::ResponseWrapperAppSpecific
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperAppSpecific' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperAppSpecific.new
  end
  ...
  describe 'test an instance of ResponseWrapperAppSpecific' do
    it 'should create an instance of ResponseWrapperAppSpecific' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperAppSpecific)
    end
  end
