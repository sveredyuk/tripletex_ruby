...
# Unit tests for TripletexApi::ListResponseAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseAddress' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseAddress.new
  end
  ...
  describe 'test an instance of ListResponseAddress' do
    it 'should create an instance of ListResponseAddress' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseAddress)
    end
  end
