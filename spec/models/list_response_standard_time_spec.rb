...
# Unit tests for TripletexApi::ListResponseStandardTime
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseStandardTime' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseStandardTime.new
  end
  ...
  describe 'test an instance of ListResponseStandardTime' do
    it 'should create an instance of ListResponseStandardTime' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseStandardTime)
    end
  end
