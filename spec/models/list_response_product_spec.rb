...
# Unit tests for TripletexApi::ListResponseProduct
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseProduct' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseProduct.new
  end
  ...
  describe 'test an instance of ListResponseProduct' do
    it 'should create an instance of ListResponseProduct' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseProduct)
    end
  end
