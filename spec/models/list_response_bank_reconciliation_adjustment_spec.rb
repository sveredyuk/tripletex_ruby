...
# Unit tests for TripletexApi::ListResponseBankReconciliationAdjustment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseBankReconciliationAdjustment' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseBankReconciliationAdjustment.new
  end
  ...
  describe 'test an instance of ListResponseBankReconciliationAdjustment' do
    it 'should create an instance of ListResponseBankReconciliationAdjustment' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseBankReconciliationAdjustment)
    end
  end
