...
# Unit tests for TripletexApi::ListResponseOrder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseOrder' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseOrder.new
  end
  ...
  describe 'test an instance of ListResponseOrder' do
    it 'should create an instance of ListResponseOrder' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseOrder)
    end
  end
