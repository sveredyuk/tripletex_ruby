...
# Unit tests for TripletexApi::ResponseWrapperEmployee
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperEmployee' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperEmployee.new
  end
  ...
  describe 'test an instance of ResponseWrapperEmployee' do
    it 'should create an instance of ResponseWrapperEmployee' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperEmployee)
    end
  end
