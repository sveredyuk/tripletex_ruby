...
# Unit tests for TripletexApi::ResponseWrapperCloseGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperCloseGroup' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperCloseGroup.new
  end
  ...
  describe 'test an instance of ResponseWrapperCloseGroup' do
    it 'should create an instance of ResponseWrapperCloseGroup' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperCloseGroup)
    end
  end
