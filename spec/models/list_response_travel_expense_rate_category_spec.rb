...
# Unit tests for TripletexApi::ListResponseTravelExpenseRateCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseTravelExpenseRateCategory' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseTravelExpenseRateCategory.new
  end
  ...
  describe 'test an instance of ListResponseTravelExpenseRateCategory' do
    it 'should create an instance of ListResponseTravelExpenseRateCategory' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseTravelExpenseRateCategory)
    end
  end
