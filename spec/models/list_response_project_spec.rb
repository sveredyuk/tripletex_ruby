...
# Unit tests for TripletexApi::ListResponseProject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseProject' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseProject.new
  end
  ...
  describe 'test an instance of ListResponseProject' do
    it 'should create an instance of ListResponseProject' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseProject)
    end
  end
