...
# Unit tests for TripletexApi::Department
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Department' do
  before do
    # run before each test
    @instance = TripletexApi::Department.new
  end
  ...
  describe 'test an instance of Department' do
    it 'should create an instance of Department' do
      expect(@instance).to be_instance_of(TripletexApi::Department)
    end
  end
  ...
  describe 'test attribute "department_number"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
