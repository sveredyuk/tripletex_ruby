...
# Unit tests for TripletexApi::PerDiemCompensation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PerDiemCompensation' do
  before do
    # run before each test
    @instance = TripletexApi::PerDiemCompensation.new
  end
  ...
  describe 'test an instance of PerDiemCompensation' do
    it 'should create an instance of PerDiemCompensation' do
      expect(@instance).to be_instance_of(TripletexApi::PerDiemCompensation)
    end
  end
