...
# Unit tests for TripletexApi::ListResponseCompany
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCompany' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCompany.new
  end
  ...
  describe 'test an instance of ListResponseCompany' do
    it 'should create an instance of ListResponseCompany' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCompany)
    end
  end
