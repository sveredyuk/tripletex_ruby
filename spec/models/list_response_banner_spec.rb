...
# Unit tests for TripletexApi::ListResponseBanner
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseBanner' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseBanner.new
  end
  ...
  describe 'test an instance of ListResponseBanner' do
    it 'should create an instance of ListResponseBanner' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseBanner)
    end
  end
