...
# Unit tests for TripletexApi::MaritimeEmployment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MaritimeEmployment' do
  before do
    # run before each test
    @instance = TripletexApi::MaritimeEmployment.new
  end
  ...
  describe 'test an instance of MaritimeEmployment' do
    it 'should create an instance of MaritimeEmployment' do
      expect(@instance).to be_instance_of(TripletexApi::MaritimeEmployment)
    end
  end
