...
# Unit tests for TripletexApi::ResponseWrapperBankStatement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperBankStatement' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperBankStatement.new
  end
  ...
  describe 'test an instance of ResponseWrapperBankStatement' do
    it 'should create an instance of ResponseWrapperBankStatement' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperBankStatement)
    end
  end
