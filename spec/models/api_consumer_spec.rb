...
# Unit tests for TripletexApi::ApiConsumer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiConsumer' do
  before do
    # run before each test
    @instance = TripletexApi::ApiConsumer.new
  end
  ...
  describe 'test an instance of ApiConsumer' do
    it 'should create an instance of ApiConsumer' do
      expect(@instance).to be_instance_of(TripletexApi::ApiConsumer)
    end
  end
