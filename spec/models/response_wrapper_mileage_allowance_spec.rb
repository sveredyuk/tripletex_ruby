...
# Unit tests for TripletexApi::ResponseWrapperMileageAllowance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperMileageAllowance' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperMileageAllowance.new
  end
  ...
  describe 'test an instance of ResponseWrapperMileageAllowance' do
    it 'should create an instance of ResponseWrapperMileageAllowance' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperMileageAllowance)
    end
  end
