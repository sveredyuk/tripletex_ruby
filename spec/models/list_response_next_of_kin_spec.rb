...
# Unit tests for TripletexApi::ListResponseNextOfKin
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseNextOfKin' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseNextOfKin.new
  end
  ...
  describe 'test an instance of ListResponseNextOfKin' do
    it 'should create an instance of ListResponseNextOfKin' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseNextOfKin)
    end
  end
