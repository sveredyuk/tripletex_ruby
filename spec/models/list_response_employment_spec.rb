...
# Unit tests for TripletexApi::ListResponseEmployment
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseEmployment' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseEmployment.new
  end
  ...
  describe 'test an instance of ListResponseEmployment' do
    it 'should create an instance of ListResponseEmployment' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseEmployment)
    end
  end
