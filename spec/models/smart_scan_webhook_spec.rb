...
# Unit tests for TripletexApi::SmartScanWebhook
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SmartScanWebhook' do
  before do
    # run before each test
    @instance = TripletexApi::SmartScanWebhook.new
  end
  ...
  describe 'test an instance of SmartScanWebhook' do
    it 'should create an instance of SmartScanWebhook' do
      expect(@instance).to be_instance_of(TripletexApi::SmartScanWebhook)
    end
  end
  ...
  describe 'test attribute "client_document_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
