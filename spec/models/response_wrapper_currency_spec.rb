...
# Unit tests for TripletexApi::ResponseWrapperCurrency
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperCurrency' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperCurrency.new
  end
  ...
  describe 'test an instance of ResponseWrapperCurrency' do
    it 'should create an instance of ResponseWrapperCurrency' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperCurrency)
    end
  end
