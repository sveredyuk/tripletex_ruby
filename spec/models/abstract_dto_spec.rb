...
# Unit tests for TripletexApi::AbstractDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AbstractDTO' do
  before do
    # run before each test
    @instance = TripletexApi::AbstractDTO.new
  end
  ...
  describe 'test an instance of AbstractDTO' do
    it 'should create an instance of AbstractDTO' do
      expect(@instance).to be_instance_of(TripletexApi::AbstractDTO)
    end
  end
