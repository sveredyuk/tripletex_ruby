...
# Unit tests for TripletexApi::ResponseWrapperCountry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperCountry' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperCountry.new
  end
  ...
  describe 'test an instance of ResponseWrapperCountry' do
    it 'should create an instance of ResponseWrapperCountry' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperCountry)
    end
  end
