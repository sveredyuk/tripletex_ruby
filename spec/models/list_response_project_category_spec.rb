...
# Unit tests for TripletexApi::ListResponseProjectCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseProjectCategory' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseProjectCategory.new
  end
  ...
  describe 'test an instance of ListResponseProjectCategory' do
    it 'should create an instance of ListResponseProjectCategory' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseProjectCategory)
    end
  end
