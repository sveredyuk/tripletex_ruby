...
# Unit tests for TripletexApi::SalaryTransaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SalaryTransaction' do
  before do
    # run before each test
    @instance = TripletexApi::SalaryTransaction.new
  end
  ...
  describe 'test an instance of SalaryTransaction' do
    it 'should create an instance of SalaryTransaction' do
      expect(@instance).to be_instance_of(TripletexApi::SalaryTransaction)
    end
  end
