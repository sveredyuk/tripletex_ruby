...
# Unit tests for TripletexApi::ListResponseMileageAllowance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseMileageAllowance' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseMileageAllowance.new
  end
  ...
  describe 'test an instance of ListResponseMileageAllowance' do
    it 'should create an instance of ListResponseMileageAllowance' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseMileageAllowance)
    end
  end
