...
# Unit tests for TripletexApi::PersonAutoCompleteDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PersonAutoCompleteDTO' do
  before do
    # run before each test
    @instance = TripletexApi::PersonAutoCompleteDTO.new
  end
  ...
  describe 'test an instance of PersonAutoCompleteDTO' do
    it 'should create an instance of PersonAutoCompleteDTO' do
      expect(@instance).to be_instance_of(TripletexApi::PersonAutoCompleteDTO)
    end
  end
