...
# Unit tests for TripletexApi::BankReconciliationMatch
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankReconciliationMatch' do
  before do
    # run before each test
    @instance = TripletexApi::BankReconciliationMatch.new
  end
  ...
  describe 'test an instance of BankReconciliationMatch' do
    it 'should create an instance of BankReconciliationMatch' do
      expect(@instance).to be_instance_of(TripletexApi::BankReconciliationMatch)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["MANUAL", "PENDING_SUGGESTION", "REJECTED_SUGGESTION", "APPROVED_SUGGESTION"])
