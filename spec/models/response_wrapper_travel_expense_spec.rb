...
# Unit tests for TripletexApi::ResponseWrapperTravelExpense
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperTravelExpense' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperTravelExpense.new
  end
  ...
  describe 'test an instance of ResponseWrapperTravelExpense' do
    it 'should create an instance of ResponseWrapperTravelExpense' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperTravelExpense)
    end
  end
