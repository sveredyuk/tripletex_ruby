...
# Unit tests for TripletexApi::AnnualAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnnualAccount' do
  before do
    # run before each test
    @instance = TripletexApi::AnnualAccount.new
  end
  ...
  describe 'test an instance of AnnualAccount' do
    it 'should create an instance of AnnualAccount' do
      expect(@instance).to be_instance_of(TripletexApi::AnnualAccount)
    end
  end
