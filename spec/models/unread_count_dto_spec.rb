...
# Unit tests for TripletexApi::UnreadCountDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UnreadCountDTO' do
  before do
    # run before each test
    @instance = TripletexApi::UnreadCountDTO.new
  end
  ...
  describe 'test an instance of UnreadCountDTO' do
    it 'should create an instance of UnreadCountDTO' do
      expect(@instance).to be_instance_of(TripletexApi::UnreadCountDTO)
    end
  end
  ...
  describe 'test attribute "read_cursor"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
