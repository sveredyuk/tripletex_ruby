...
# Unit tests for TripletexApi::ProductUnit
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductUnit' do
  before do
    # run before each test
    @instance = TripletexApi::ProductUnit.new
  end
  ...
  describe 'test an instance of ProductUnit' do
    it 'should create an instance of ProductUnit' do
      expect(@instance).to be_instance_of(TripletexApi::ProductUnit)
    end
  end
