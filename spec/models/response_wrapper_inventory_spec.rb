...
# Unit tests for TripletexApi::ResponseWrapperInventory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperInventory' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperInventory.new
  end
  ...
  describe 'test an instance of ResponseWrapperInventory' do
    it 'should create an instance of ResponseWrapperInventory' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperInventory)
    end
  end
