...
# Unit tests for TripletexApi::ListResponseCompanyHoliday
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCompanyHoliday' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCompanyHoliday.new
  end
  ...
  describe 'test an instance of ListResponseCompanyHoliday' do
    it 'should create an instance of ListResponseCompanyHoliday' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCompanyHoliday)
    end
  end
