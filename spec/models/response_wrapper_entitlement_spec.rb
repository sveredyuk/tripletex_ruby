...
# Unit tests for TripletexApi::ResponseWrapperEntitlement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperEntitlement' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperEntitlement.new
  end
  ...
  describe 'test an instance of ResponseWrapperEntitlement' do
    it 'should create an instance of ResponseWrapperEntitlement' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperEntitlement)
    end
  end
