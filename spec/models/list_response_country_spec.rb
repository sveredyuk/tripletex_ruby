...
# Unit tests for TripletexApi::ListResponseCountry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCountry' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCountry.new
  end
  ...
  describe 'test an instance of ListResponseCountry' do
    it 'should create an instance of ListResponseCountry' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCountry)
    end
  end
