...
# Unit tests for TripletexApi::ListResponseEntitlement
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseEntitlement' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseEntitlement.new
  end
  ...
  describe 'test an instance of ListResponseEntitlement' do
    it 'should create an instance of ListResponseEntitlement' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseEntitlement)
    end
  end
