...
# Unit tests for TripletexApi::ResponseWrapperProject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperProject' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperProject.new
  end
  ...
  describe 'test an instance of ResponseWrapperProject' do
    it 'should create an instance of ResponseWrapperProject' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperProject)
    end
  end
