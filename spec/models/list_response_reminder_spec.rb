...
# Unit tests for TripletexApi::ListResponseReminder
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseReminder' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseReminder.new
  end
  ...
  describe 'test an instance of ListResponseReminder' do
    it 'should create an instance of ListResponseReminder' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseReminder)
    end
  end
