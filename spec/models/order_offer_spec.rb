...
# Unit tests for TripletexApi::OrderOffer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrderOffer' do
  before do
    # run before each test
    @instance = TripletexApi::OrderOffer.new
  end
  ...
  describe 'test an instance of OrderOffer' do
    it 'should create an instance of OrderOffer' do
      expect(@instance).to be_instance_of(TripletexApi::OrderOffer)
    end
  end
