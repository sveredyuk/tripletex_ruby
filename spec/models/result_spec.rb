...
# Unit tests for TripletexApi::Result
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Result' do
  before do
    # run before each test
    @instance = TripletexApi::Result.new
  end
  ...
  describe 'test an instance of Result' do
    it 'should create an instance of Result' do
      expect(@instance).to be_instance_of(TripletexApi::Result)
    end
  end
  describe 'test attribute "file"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["DEPARTMENTS", "EMPLOYEES", "VATCODES", "ACCOUNTS", "CUSTOMERS", "CUSTOMERS_CATEGORIES", "VENDORS", "VENDORS_CATEGORIES", "CONTACTS", "DELIVERY_ADDRESSES", "PRODUCTS", "PRODUCTS_CATEGORIES", "PROJECTS", "PROJECTS_CATEGORIES"])
       #validator.allowable_values.each do |value|
       #  expect { @instance.file = value }.not_to raise_error
       #end
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
       #validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["IGNORED", "UPDATED", "CREATED", "ERROR"])
       #validator.allowable_values.each do |value|
