...
# Unit tests for TripletexApi::ListResponseSupplier
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseSupplier' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseSupplier.new
  end
  ...
  describe 'test an instance of ListResponseSupplier' do
    it 'should create an instance of ListResponseSupplier' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseSupplier)
    end
  end
