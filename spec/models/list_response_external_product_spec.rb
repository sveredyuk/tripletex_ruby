...
# Unit tests for TripletexApi::ListResponseExternalProduct
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseExternalProduct' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseExternalProduct.new
  end
  ...
  describe 'test an instance of ListResponseExternalProduct' do
    it 'should create an instance of ListResponseExternalProduct' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseExternalProduct)
    end
  end
