...
# Unit tests for TripletexApi::ResponseWrapperOrderOffer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperOrderOffer' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperOrderOffer.new
  end
  ...
  describe 'test an instance of ResponseWrapperOrderOffer' do
    it 'should create an instance of ResponseWrapperOrderOffer' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperOrderOffer)
    end
  end
