...
# Unit tests for TripletexApi::ListResponseAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseAccount' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseAccount.new
  end
  ...
  describe 'test an instance of ListResponseAccount' do
    it 'should create an instance of ListResponseAccount' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseAccount)
    end
  end
