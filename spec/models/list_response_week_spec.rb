...
# Unit tests for TripletexApi::ListResponseWeek
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseWeek' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseWeek.new
  end
  ...
  describe 'test an instance of ListResponseWeek' do
    it 'should create an instance of ListResponseWeek' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseWeek)
    end
  end
