...
# Unit tests for TripletexApi::ListResponseSupplierBalance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseSupplierBalance' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseSupplierBalance.new
  end
  ...
  describe 'test an instance of ListResponseSupplierBalance' do
    it 'should create an instance of ListResponseSupplierBalance' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseSupplierBalance)
    end
  end
