...
# Unit tests for TripletexApi::VNTCStatusDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VNTCStatusDTO' do
  before do
    # run before each test
    @instance = TripletexApi::VNTCStatusDTO.new
  end
  ...
  describe 'test an instance of VNTCStatusDTO' do
    it 'should create an instance of VNTCStatusDTO' do
      expect(@instance).to be_instance_of(TripletexApi::VNTCStatusDTO)
    end
  end
  ...
  describe 'test attribute "external_sender_id"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "part_count"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
