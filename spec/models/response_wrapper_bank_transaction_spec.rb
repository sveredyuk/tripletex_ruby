...
# Unit tests for TripletexApi::ResponseWrapperBankTransaction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperBankTransaction' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperBankTransaction.new
  end
  ...
  describe 'test an instance of ResponseWrapperBankTransaction' do
    it 'should create an instance of ResponseWrapperBankTransaction' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperBankTransaction)
    end
  end
