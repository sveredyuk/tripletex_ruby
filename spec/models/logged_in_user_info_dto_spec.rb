...
# Unit tests for TripletexApi::LoggedInUserInfoDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LoggedInUserInfoDTO' do
  before do
    # run before each test
    @instance = TripletexApi::LoggedInUserInfoDTO.new
  end
  ...
  describe 'test an instance of LoggedInUserInfoDTO' do
    it 'should create an instance of LoggedInUserInfoDTO' do
      expect(@instance).to be_instance_of(TripletexApi::LoggedInUserInfoDTO)
    end
  end
