...
# Unit tests for TripletexApi::ListResponseNotification
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseNotification' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseNotification.new
  end
  ...
  describe 'test an instance of ListResponseNotification' do
    it 'should create an instance of ListResponseNotification' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseNotification)
    end
  end
