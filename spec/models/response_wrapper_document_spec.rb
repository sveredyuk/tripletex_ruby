...
# Unit tests for TripletexApi::ResponseWrapperDocument
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperDocument' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperDocument.new
  end
  ...
  describe 'test an instance of ResponseWrapperDocument' do
    it 'should create an instance of ResponseWrapperDocument' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperDocument)
    end
  end
