...
# Unit tests for TripletexApi::ListResponseOrderLine
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseOrderLine' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseOrderLine.new
  end
  ...
  describe 'test an instance of ListResponseOrderLine' do
    it 'should create an instance of ListResponseOrderLine' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseOrderLine)
    end
  end
