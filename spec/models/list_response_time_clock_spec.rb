...
# Unit tests for TripletexApi::ListResponseTimeClock
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseTimeClock' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseTimeClock.new
  end
  ...
  describe 'test an instance of ListResponseTimeClock' do
    it 'should create an instance of ListResponseTimeClock' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseTimeClock)
    end
  end
