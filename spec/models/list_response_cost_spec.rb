...
# Unit tests for TripletexApi::ListResponseCost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCost' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCost.new
  end
  ...
  describe 'test an instance of ListResponseCost' do
    it 'should create an instance of ListResponseCost' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCost)
    end
  end
