...
# Unit tests for TripletexApi::ListResponsePersonAutoCompleteDTO
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponsePersonAutoCompleteDTO' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponsePersonAutoCompleteDTO.new
  end
  ...
  describe 'test an instance of ListResponsePersonAutoCompleteDTO' do
    it 'should create an instance of ListResponsePersonAutoCompleteDTO' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponsePersonAutoCompleteDTO)
    end
  end
