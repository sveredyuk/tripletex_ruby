...
# Unit tests for TripletexApi::ListResponseTravelExpenseRateCategoryGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseTravelExpenseRateCategoryGroup' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseTravelExpenseRateCategoryGroup.new
  end
  ...
  describe 'test an instance of ListResponseTravelExpenseRateCategoryGroup' do
    it 'should create an instance of ListResponseTravelExpenseRateCategoryGroup' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseTravelExpenseRateCategoryGroup)
    end
  end
