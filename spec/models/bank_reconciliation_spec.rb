...
# Unit tests for TripletexApi::BankReconciliation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'BankReconciliation' do
  before do
    # run before each test
    @instance = TripletexApi::BankReconciliation.new
  end
  ...
  describe 'test an instance of BankReconciliation' do
    it 'should create an instance of BankReconciliation' do
      expect(@instance).to be_instance_of(TripletexApi::BankReconciliation)
    end
  end
  ...
  describe 'test attribute "outgoing_bank_account_balance_currency"' do
    it 'should work' do
       # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
