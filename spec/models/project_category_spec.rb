...
# Unit tests for TripletexApi::ProjectCategory
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProjectCategory' do
  before do
    # run before each test
    @instance = TripletexApi::ProjectCategory.new
  end
  ...
  describe 'test an instance of ProjectCategory' do
    it 'should create an instance of ProjectCategory' do
      expect(@instance).to be_instance_of(TripletexApi::ProjectCategory)
    end
  end
