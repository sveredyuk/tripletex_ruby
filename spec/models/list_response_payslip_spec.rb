...
# Unit tests for TripletexApi::ListResponsePayslip
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponsePayslip' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponsePayslip.new
  end
  ...
  describe 'test an instance of ListResponsePayslip' do
    it 'should create an instance of ListResponsePayslip' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponsePayslip)
    end
  end
