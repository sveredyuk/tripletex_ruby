...
# Unit tests for TripletexApi::ResponseWrapperModules
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperModules' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperModules.new
  end
  ...
  describe 'test an instance of ResponseWrapperModules' do
    it 'should create an instance of ResponseWrapperModules' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperModules)
    end
  end
