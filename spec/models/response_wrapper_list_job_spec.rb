...
# Unit tests for TripletexApi::ResponseWrapperListJob
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperListJob' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperListJob.new
  end
  ...
  describe 'test an instance of ResponseWrapperListJob' do
    it 'should create an instance of ResponseWrapperListJob' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperListJob)
    end
  end
