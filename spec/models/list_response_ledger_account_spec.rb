...
# Unit tests for TripletexApi::ListResponseLedgerAccount
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseLedgerAccount' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseLedgerAccount.new
  end
  ...
  describe 'test an instance of ListResponseLedgerAccount' do
    it 'should create an instance of ListResponseLedgerAccount' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseLedgerAccount)
    end
  end
