...
# Unit tests for TripletexApi::ResponseWrapperObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperObject' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperObject.new
  end
  ...
  describe 'test an instance of ResponseWrapperObject' do
    it 'should create an instance of ResponseWrapperObject' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperObject)
    end
  end
