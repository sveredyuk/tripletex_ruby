...
# Unit tests for TripletexApi::ListResponseCurrency
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponseCurrency' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponseCurrency.new
  end
  ...
  describe 'test an instance of ListResponseCurrency' do
    it 'should create an instance of ListResponseCurrency' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponseCurrency)
    end
  end
