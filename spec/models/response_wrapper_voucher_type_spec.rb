...
# Unit tests for TripletexApi::ResponseWrapperVoucherType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ResponseWrapperVoucherType' do
  before do
    # run before each test
    @instance = TripletexApi::ResponseWrapperVoucherType.new
  end
  ...
  describe 'test an instance of ResponseWrapperVoucherType' do
    it 'should create an instance of ResponseWrapperVoucherType' do
      expect(@instance).to be_instance_of(TripletexApi::ResponseWrapperVoucherType)
    end
  end
