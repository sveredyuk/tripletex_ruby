...
# Unit tests for TripletexApi::WeeklyStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'WeeklyStatus' do
  before do
    # run before each test
    @instance = TripletexApi::WeeklyStatus.new
  end
  ...
  describe 'test an instance of WeeklyStatus' do
    it 'should create an instance of WeeklyStatus' do
      expect(@instance).to be_instance_of(TripletexApi::WeeklyStatus)
    end
  end
