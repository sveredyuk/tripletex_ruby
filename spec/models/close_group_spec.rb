...
# Unit tests for TripletexApi::CloseGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CloseGroup' do
  before do
    # run before each test
    @instance = TripletexApi::CloseGroup.new
  end
  ...
  describe 'test an instance of CloseGroup' do
    it 'should create an instance of CloseGroup' do
      expect(@instance).to be_instance_of(TripletexApi::CloseGroup)
    end
  end
