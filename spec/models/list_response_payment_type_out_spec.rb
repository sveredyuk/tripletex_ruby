...
# Unit tests for TripletexApi::ListResponsePaymentTypeOut
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ListResponsePaymentTypeOut' do
  before do
    # run before each test
    @instance = TripletexApi::ListResponsePaymentTypeOut.new
  end
  ...
  describe 'test an instance of ListResponsePaymentTypeOut' do
    it 'should create an instance of ListResponsePaymentTypeOut' do
      expect(@instance).to be_instance_of(TripletexApi::ListResponsePaymentTypeOut)
    end
  end
