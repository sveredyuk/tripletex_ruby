...
module TripletexApi
  class LedgervoucherTypeApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :fields Fields filter pattern
    # @return [Array<(ResponseWrapperVoucherType, Fixnum, Hash)>] ResponseWrapperVoucherType data, response status code and response headers
    def get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LedgervoucherTypeApi.get ..."
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling LedgervoucherTypeApi.get"
      end
      # resource path
      local_var_path = "/ledger/voucherType/{id}".sub('{' + 'id' + '}', id.to_s)
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ResponseWrapperVoucherType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LedgervoucherTypeApi#get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @option opts [String] :sorting Sorting pattern
    # @option opts [String] :fields Fields filter pattern
    # @return [Array<(ListResponseVoucherType, Fixnum, Hash)>] ListResponseVoucherType data, response status code and response headers
    def search_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: LedgervoucherTypeApi.search ..."
      end
      # resource path
      local_var_path = "/ledger/voucherType"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'ListResponseVoucherType')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LedgervoucherTypeApi#search\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
