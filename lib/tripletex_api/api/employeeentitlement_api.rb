...
module TripletexApi
  class EmployeeentitlementApi
    ...
    def grant_client_entitlements_by_template_with_http_info(employee_id, customer_id, template, opts = {})
      ...
      # verify enum value
      if @api_client.config.client_side_validation && !['NONE_PRIVILEGES', 'STANDARD_PRIVILEGES_ACCOUNTANT', 'STANDARD_PRIVILEGES_AUDITOR', 'ALL_PRIVILEGES', 'AGRO_READ_ONLY', 'AGRO_READ_APPROVE', 'AGRO_READ_WRITE', 'AGRO_READ_WRITE_APPROVE', 'MAMUT_PAYROLL_ADMIN', 'MAMUT_PAYROLL_CLERK', 'AGRO_PAYROLL_ADMIN', 'AGRO_PAYROLL_CLERK'].include?(template)
        fail ArgumentError, "invalid value for 'template', must be one of NONE_PRIVILEGES, STANDARD_PRIVILEGES_ACCOUNTANT, STANDARD_PRIVILEGES_AUDITOR, ALL_PRIVILEGES, AGRO_READ_ONLY, AGRO_READ_APPROVE, AGRO_READ_WRITE, AGRO_READ_WRITE_APPROVE, MAMUT_PAYROLL_ADMIN, MAMUT_PAYROLL_CLERK, AGRO_PAYROLL_ADMIN, AGRO_PAYROLL_CLERK"
      end
      # resource path
    ...
    def grant_entitlements_by_template_with_http_info(employee_id, template, opts = {})
      ...
      # verify enum value
      if @api_client.config.client_side_validation && !['NONE_PRIVILEGES', 'ALL_PRIVILEGES', 'INVOICING_MANAGER', 'PERSONELL_MANAGER', 'ACCOUNTANT', 'AUDITOR', 'DEPARTMENT_LEADER'].include?(template)
        fail ArgumentError, "invalid value for 'template', must be one of NONE_PRIVILEGES, ALL_PRIVILEGES, INVOICING_MANAGER, PERSONELL_MANAGER, ACCOUNTANT, AUDITOR, DEPARTMENT_LEADER"
      end
      # resource path
