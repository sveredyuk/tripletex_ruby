...
module TripletexApi
  class BankApi
    ...
    # @option opts [String] :sorting Sorting pattern
    # @option opts [String] :fields Fields filter pattern
    # @return [Array<(ListResponseBank, Fixnum, Hash)>] ListResponseBank data, response status code and response headers
    def search_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: BankApi.search ..."
      end
      # resource path
      local_var_path = "/bank"
      ...
      query_params[:'registerNumbers'] = opts[:'register_numbers'] if !opts[:'register_numbers'].nil?
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ListResponseBank')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: BankApi#search\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
