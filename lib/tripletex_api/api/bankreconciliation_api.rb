...
module TripletexApi
  class BankreconciliationApi
    ...
    def fetch_from_bank(account_id, accounting_period_id, opts = {})
      data, _status_code, _headers = fetch_from_bank_with_http_info(account_id, accounting_period_id, opts)
      return data
    end
    ...
    def fetch_from_bank_with_http_info(account_id, accounting_period_id, opts = {})
      if @api_client.config.debugging
