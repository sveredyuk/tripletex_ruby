  ...
  class ProductexternalApi
    ...
    def search_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && opts[:'wholesaler'] && !['AHLSELL', 'BROEDRENE_DAHL', 'ELEKTROSKANDIA', 'HEIDENREICH', 'ONNINEN', 'OTRA', 'SOLAR', 'BERGAARD_AMUNDSEN', 'BERGAARD_AMUNDSEN_STAVANGER', 'SORLANDET_ELEKTRO', 'ETMAN_DISTRIBUSJON', 'ETM_OST', 'CENIKA', 'EP_ENGROS', 'BETEK', 'DGROUP', 'FAGERHULT', 'GLAMOX', 'SCHNEIDER', 'STOKKAN', 'WURTH', 'ELEKTROIMPORTOEREN', 'THERMOFLOOR', 'LYSKOMPONENTER', 'NORDESIGN'].include?(opts[:'wholesaler'])
        fail ArgumentError, 'invalid value for "wholesaler", must be one of AHLSELL, BROEDRENE_DAHL, ELEKTROSKANDIA, HEIDENREICH, ONNINEN, OTRA, SOLAR, BERGAARD_AMUNDSEN, BERGAARD_AMUNDSEN_STAVANGER, SORLANDET_ELEKTRO, ETMAN_DISTRIBUSJON, ETM_OST, CENIKA, EP_ENGROS, BETEK, DGROUP, FAGERHULT, GLAMOX, SCHNEIDER, STOKKAN, WURTH, ELEKTROIMPORTOEREN, THERMOFLOOR, LYSKOMPONENTER, NORDESIGN'
      end
      # resource path
