...
module TripletexApi
  class CompanyaltinnApi
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [AltinnCompanyModule] :body Partial object describing what should be updated
    # @return [Array<(ResponseWrapperAltinnCompanyModule, Fixnum, Hash)>] ResponseWrapperAltinnCompanyModule data, response status code and response headers
    def put_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CompanyaltinnApi.put ..."
      end
      # resource path
      local_var_path = "/company/settings/altinn"
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path,
        ...
        :return_type => 'ResponseWrapperAltinnCompanyModule')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CompanyaltinnApi#put\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def search_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug "Calling API: CompanyaltinnApi.search ..."
      end
      # resource path
      local_var_path = "/company/settings/altinn"
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :return_type => 'ResponseWrapperAltinnCompanyModule')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CompanyaltinnApi#search\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
