...
module TripletexApi
  ...
  class Bank
    ...
    attr_accessor :bank_statement_file_format_support

    # Register numbers belonging to bank.
    attr_accessor :register_numbers
    ...
    def self.swagger_types
      {
        ...
        :'url' => :'String',
        :'name' => :'String',
        :'bank_statement_file_format_support' => :'Array<String>',
        :'register_numbers' => :'Array<Integer>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bankStatementFileFormatSupport')
        if (value = attributes[:'bankStatementFileFormatSupport']).is_a?(Array)
          self.bank_statement_file_format_support = value
        end
      end

      if attributes.has_key?(:'registerNumbers')
        if (value = attributes[:'registerNumbers']).is_a?(Array)
          self.register_numbers = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          url == o.url &&
          name == o.name &&
          bank_statement_file_format_support == o.bank_statement_file_format_support &&
          register_numbers == o.register_numbers
    end
    ...
    def hash
      [id, version, changes, url, name, bank_statement_file_format_support, register_numbers].hash
    end
