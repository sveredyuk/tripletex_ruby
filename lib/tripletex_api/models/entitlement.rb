...
module TripletexApi
  ...
  class Entitlement
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'entitlementId')
        self.entitlement_id = attributes[:'entitlementId']
      end
    ...
    def list_invalid_properties
      ...
      if @entitlement_id.nil?
        invalid_properties.push("invalid value for 'entitlement_id', entitlement_id cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @entitlement_id.nil?
    ...
    def hash
      [id, version, changes, url, employee, name, entitlement_id, customer].hash
    end
