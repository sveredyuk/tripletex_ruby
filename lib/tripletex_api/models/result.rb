...
module TripletexApi
  ...
  class Result
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dbId')
        self.db_id = attributes[:'dbId']
      end
      ...
      if attributes.has_key?(:'dto')
        self.dto = attributes[:'dto']
      end
    ...
    def valid?
      file_validator = EnumAttributeValidator.new('String', ["DEPARTMENTS", "EMPLOYEES", "VATCODES", "ACCOUNTS", "CUSTOMERS", "CUSTOMERS_CATEGORIES", "VENDORS", "VENDORS_CATEGORIES", "CONTACTS", "DELIVERY_ADDRESSES", "PRODUCTS", "PRODUCTS_CATEGORIES", "PROJECTS", "PROJECTS_CATEGORIES"])
      return false unless file_validator.valid?(@file)
      type_validator = EnumAttributeValidator.new('String', ["IGNORED", "UPDATED", "CREATED", "ERROR"])
    ...
    def file=(file)
      validator = EnumAttributeValidator.new('String', ["DEPARTMENTS", "EMPLOYEES", "VATCODES", "ACCOUNTS", "CUSTOMERS", "CUSTOMERS_CATEGORIES", "VENDORS", "VENDORS_CATEGORIES", "CONTACTS", "DELIVERY_ADDRESSES", "PRODUCTS", "PRODUCTS_CATEGORIES", "PROJECTS", "PROJECTS_CATEGORIES"])
      unless validator.valid?(file)
        fail ArgumentError, "invalid value for 'file', must be one of #{validator.allowable_values}."
      end
      @file = file
    end
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["IGNORED", "UPDATED", "CREATED", "ERROR"])
    ...
    def hash
      [file, line, type, number, db_id, input, output, log, record, dto].hash
    end
