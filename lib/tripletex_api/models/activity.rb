...
module TripletexApi
  ...
  class Activity
    ...
    attr_accessor :is_project_activity
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isProjectActivity')
        self.is_project_activity = attributes[:'isProjectActivity']
      else
        self.is_project_activity = false
      end

      if attributes.has_key?(:'isGeneral')
        self.is_general = attributes[:'isGeneral']
      else
      ...
      if attributes.has_key?(:'isTask')
        self.is_task = attributes[:'isTask']
      else
        self.is_task = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_project_activity == o.is_project_activity &&
    ...
    def hash
      [id, version, changes, url, name, number, description, is_project_activity, is_general, is_chargeable, is_task].hash
    end
