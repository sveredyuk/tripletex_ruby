...
module TripletexApi
  ...
  class SessionToken
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'consumerToken')
        self.consumer_token = attributes[:'consumerToken']
      end

      if attributes.has_key?(:'employeeToken')
        self.employee_token = attributes[:'employeeToken']
      end
    ...
    def list_invalid_properties
      ...
      if !@token.nil? && @token.to_s.length > 100
    ...
    def valid?
      ...
      return false if !@token.nil? && @token.to_s.length > 100
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          changes == o.changes &&
          url == o.url &&
          consumer_token == o.consumer_token &&
          employee_token == o.employee_token &&
    ...
    def hash
      [id, version, changes, url, consumer_token, employee_token, expiration_date, token, encryption_key].hash
    end
