...
module TripletexApi
  ...
  class ProjectOrderLine
    ...
    def hash
      [id, version, changes, url, product, inventory, description, count, unit_cost_currency, unit_price_excluding_vat_currency, currency, markup, discount, vat_type, amount_excluding_vat_currency, amount_including_vat_currency, project, date, is_chargeable].hash
    end
