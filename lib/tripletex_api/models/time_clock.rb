...
module TripletexApi
  ...
  class TimeClock
    ...
    def list_invalid_properties
      ...
      if !@hours_start.nil? && @hours_start < 0.0
        invalid_properties.push("invalid value for 'hours_start', must be greater than or equal to 0.0.")
      end
    ...
    def valid?
      ...
      return false if !@hours_start.nil? && @hours_start < 0.0
      return true
    end
    ...
    def hours_start=(hours_start)
      ...
      if !hours_start.nil? && hours_start < 0.0
        fail ArgumentError, "invalid value for 'hours_start', must be greater than or equal to 0.0."
      end
