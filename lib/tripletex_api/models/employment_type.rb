...
module TripletexApi
  ...
  class EmploymentType
    ...
    def valid?
      ...
      employment_type_validator = EnumAttributeValidator.new('String', ["TYPE_OF_EMPLOYMENT_RELATIONSHIP"])
    ...
    def employment_type=(employment_type)
      validator = EnumAttributeValidator.new('String', ["TYPE_OF_EMPLOYMENT_RELATIONSHIP"])
    ...
    def hash
      [id, version, changes, url, employment_type, name_no, code].hash
    end
