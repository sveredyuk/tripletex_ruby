  ...
  class PaymentTypeOut
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'isBruttoWageDeduction')
        ...
        self.is_brutto_wage_deduction = false
      end
