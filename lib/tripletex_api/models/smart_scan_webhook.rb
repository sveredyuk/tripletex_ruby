...
module TripletexApi
  ...
  class SmartScanWebhook
    attr_accessor :_self

    attr_accessor :document_id

    attr_accessor :client_document_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ClientDocumentId')
        self.client_document_id = attributes[:'ClientDocumentId']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          client_document_id == o.client_document_id
    end
    ...
    def hash
      [_self, document_id, client_document_id].hash
    end
