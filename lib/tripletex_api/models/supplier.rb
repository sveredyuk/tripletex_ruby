...
module TripletexApi
  ...
  class Supplier
    ...
    def hash
      [id, version, changes, url, name, organization_number, supplier_number, customer_number, is_supplier, is_customer, is_inactive, email, bank_accounts, invoice_email, phone_number, phone_number_mobile, description, is_private_individual, show_products, account_manager, postal_address, physical_address, delivery_address, category1, category2, category3].hash
    end
