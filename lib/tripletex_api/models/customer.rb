...
module TripletexApi
  ...
  class Customer
    ...
    def hash
      [id, version, changes, url, name, organization_number, supplier_number, customer_number, is_supplier, is_customer, is_inactive, account_manager, email, invoice_email, bank_accounts, phone_number, phone_number_mobile, description, is_private_individual, postal_address, physical_address, delivery_address, category1, category2, category3].hash
    end
