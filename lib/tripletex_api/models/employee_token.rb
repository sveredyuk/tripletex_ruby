...
module TripletexApi
  ...
  class EmployeeToken
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'apiConsumer')
        self.api_consumer = attributes[:'apiConsumer']
      end
    ...
    def hash
      [id, version, changes, url, employee, api_consumer, token, expiration_date].hash
    end
