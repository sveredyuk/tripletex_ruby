...
module TripletexApi
  ...
  class TimesheetEntrySearchResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sumAllHours')
        self.sum_all_hours = attributes[:'sumAllHours']
      end
    ...
    def hash
      [full_result_size, from, count, version_digest, values, sum_all_hours].hash
    end
