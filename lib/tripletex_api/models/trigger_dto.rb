...
module TripletexApi
  ...
  class TriggerDTO
    ...
    attr_accessor :previous_fire_time
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'calendarName')
        self.calendar_name = attributes[:'calendarName']
      end
      ...
      if attributes.has_key?(:'previousFireTime')
        self.previous_fire_time = attributes[:'previousFireTime']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          calendar_name == o.calendar_name &&
          description == o.description &&
          name == o.name &&
          next_fire_time == o.next_fire_time &&
          previous_fire_time == o.previous_fire_time &&
          state == o.state
    end
