...
module TripletexApi
  ...
  class BankStatement
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'balanceCurrency')
        self.balance_currency = attributes[:'balanceCurrency']
      end
    ...
    def hash
      [id, version, changes, url, balance_currency, file_name, bank, transactions].hash
    end
