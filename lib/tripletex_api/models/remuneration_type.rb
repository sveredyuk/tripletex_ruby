...
module TripletexApi
  ...
  class RemunerationType
    ...
    def list_invalid_properties
      ...
      if @remuneration_type.nil?
        invalid_properties.push("invalid value for 'remuneration_type', remuneration_type cannot be nil.")
      end
    ...
    def valid?
      return false if @remuneration_type.nil?
      remuneration_type_validator = EnumAttributeValidator.new('String', ["REMUNERATION_TYPE"])
    ...
    def remuneration_type=(remuneration_type)
      validator = EnumAttributeValidator.new('String', ["REMUNERATION_TYPE"])
    ...
    def hash
      [id, version, changes, url, remuneration_type, name_no, code].hash
    end
