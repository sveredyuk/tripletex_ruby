...
module TripletexApi
  ...
  class Invoice
    ...
    def hash
      [id, version, changes, url, invoice_number, invoice_date, customer, invoice_due_date, kid, comment, orders, project_invoice_details, voucher, delivery_date, amount, amount_currency, amount_excluding_vat, amount_excluding_vat_currency, amount_roundoff, amount_roundoff_currency, amount_outstanding, amount_outstanding_total, sum_remits, currency, is_credit_note, is_charged, postings, reminders, ehf_send_status].hash
    end
