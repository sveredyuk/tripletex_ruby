...
module TripletexApi
  ...
  class ApiError
    ...
    def self.swagger_types
      {
        ...
        :'validation_messages' => :'Array<ApiValidationMessage>',
        :'request_id' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'developerMessage')
        self.developer_message = attributes[:'developerMessage']
      end

      if attributes.has_key?(:'validationMessages')
        if (value = attributes[:'validationMessages']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          validation_messages == o.validation_messages &&
    ...
    def hash
      [status, code, message, link, developer_message, validation_messages, request_id].hash
    end
