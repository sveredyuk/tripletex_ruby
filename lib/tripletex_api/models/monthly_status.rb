...
module TripletexApi
  ...
  class MonthlyStatus
    ...
    attr_accessor :hours_paid

    attr_accessor :vacation_transferred

    attr_accessor :vacation_paid

    attr_accessor :wage_payment
    ...
    def self.attribute_map
      {
        ...
        :'vacation_transferred' => :'vacationTransferred',
    ...
    def self.swagger_types
      {
        ...
        :'date' => :'String',
        :'hours_paid' => :'Float',
        :'vacation_transferred' => :'Float',
        :'vacation_paid' => :'Float',
        :'wage_payment' => :'Payslip',
        :'completed' => :'BOOLEAN',
        :'approved' => :'BOOLEAN',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hoursPaid')
        self.hours_paid = attributes[:'hoursPaid']
      end

      if attributes.has_key?(:'vacationTransferred')
        self.vacation_transferred = attributes[:'vacationTransferred']
      end

      if attributes.has_key?(:'vacationPaid')
        self.vacation_paid = attributes[:'vacationPaid']
      end

      if attributes.has_key?(:'wagePayment')
        self.wage_payment = attributes[:'wagePayment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          employee == o.employee &&
          date == o.date &&
          hours_paid == o.hours_paid &&
          vacation_transferred == o.vacation_transferred &&
          vacation_paid == o.vacation_paid &&
          wage_payment == o.wage_payment &&
    ...
    def hash
      [id, version, changes, url, employee, date, hours_paid, vacation_transferred, vacation_paid, wage_payment, completed, approved, approved_by, approved_date].hash
    end
