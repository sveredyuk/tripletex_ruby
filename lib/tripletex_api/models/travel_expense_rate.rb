...
module TripletexApi
  ...
  class TravelExpenseRate
    ...
    attr_accessor :breakfast_deduction_rate

    attr_accessor :lunch_deduction_rate

    attr_accessor :dinner_deduction_rate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'breakfastDeductionRate')
        self.breakfast_deduction_rate = attributes[:'breakfastDeductionRate']
      end

      if attributes.has_key?(:'lunchDeductionRate')
        self.lunch_deduction_rate = attributes[:'lunchDeductionRate']
      end

      if attributes.has_key?(:'dinnerDeductionRate')
        self.dinner_deduction_rate = attributes[:'dinnerDeductionRate']
      end
    ...
    def list_invalid_properties
      ...
      if @rate_category.nil?
        invalid_properties.push("invalid value for 'rate_category', rate_category cannot be nil.")
      end
    ...
    def valid?
      return false if @rate_category.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          zone == o.zone &&
          rate == o.rate &&
          breakfast_deduction_rate == o.breakfast_deduction_rate &&
          lunch_deduction_rate == o.lunch_deduction_rate &&
          dinner_deduction_rate == o.dinner_deduction_rate
    end
    ...
    def hash
      [id, version, changes, url, rate_category, zone, rate, breakfast_deduction_rate, lunch_deduction_rate, dinner_deduction_rate].hash
    end
