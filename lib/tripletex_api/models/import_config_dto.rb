...
module TripletexApi
  ...
  class ImportConfigDTO
    attr_accessor :only_users

    attr_accessor :skip_users

    attr_accessor :skip_accounts
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'onlyUsers')
        self.only_users = attributes[:'onlyUsers']
      else
        self.only_users = false
      end

      if attributes.has_key?(:'skipUsers')
        self.skip_users = attributes[:'skipUsers']
      else
        self.skip_users = false
      end

      if attributes.has_key?(:'skipAccounts')
        self.skip_accounts = attributes[:'skipAccounts']
      else
        self.skip_accounts = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          only_users == o.only_users &&
          skip_users == o.skip_users &&
          skip_accounts == o.skip_accounts
    end
    ...
    def hash
      [only_users, skip_users, skip_accounts].hash
    end
