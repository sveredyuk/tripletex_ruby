...
module TripletexApi
  ...
  class PerDiemCompensation
    ...
    def list_invalid_properties
      ...
      if @location.to_s.length > 255
        invalid_properties.push("invalid value for 'location', the character length must be smaller than or equal to 255.")
      end
    ...
    def valid?
      ...
      return false if @location.to_s.length > 255
      return true
    end
    ...
    def location=(location)
      ...
      if location.to_s.length > 255
        fail ArgumentError, "invalid value for 'location', the character length must be smaller than or equal to 255."
      end
    ...
    def hash
      [id, version, changes, url, travel_expense, rate_type, rate_category, zone, overnight_accommodation, location, address, count, rate, amount, is_deduction_for_breakfast, is_deduction_for_lunch, is_deduction_for_dinner].hash
    end
