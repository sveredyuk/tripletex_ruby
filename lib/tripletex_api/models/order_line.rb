...
module TripletexApi
  ...
  class OrderLine
    ...
    def hash
      [id, version, changes, url, product, inventory, description, count, unit_cost_currency, unit_price_excluding_vat_currency, currency, markup, discount, vat_type, amount_excluding_vat_currency, amount_including_vat_currency, order, unit_price_including_vat_currency, is_subscription, subscription_period_start, subscription_period_end].hash
    end
