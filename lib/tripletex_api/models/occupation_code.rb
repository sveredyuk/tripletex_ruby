...
module TripletexApi
  ...
  class OccupationCode
    ...
    def list_invalid_properties
      ...
      if !@code.nil? && @code.to_s.length > 7
        invalid_properties.push("invalid value for 'code', the character length must be smaller than or equal to 7.")
      end
    ...
    def valid?
      ...
      return false if !@code.nil? && @code.to_s.length > 7
      return true
    end
    ...
    def code=(code)
      ...
      if !code.nil? && code.to_s.length > 7
        fail ArgumentError, "invalid value for 'code', the character length must be smaller than or equal to 7."
      end
    ...
    def hash
      [id, version, changes, url, name_no, code].hash
    end
