...
module TripletexApi
  ...
  class BankReconciliation
    ...
    def hash
      [id, version, changes, url, account, accounting_period, voucher, bank_statement, is_closed, bank_account_closing_balance_currency, closed_date, closed_by_contact, closed_by_employee].hash
    end
