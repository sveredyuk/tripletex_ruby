...
module TripletexApi
  ...
  class SupplierBalance
    ...
    attr_accessor :balance_in

    attr_accessor :balance_change

    attr_accessor :balance_out

    # Currencies that have been used prior to this period, for the given filter
    attr_accessor :balance_in_currencies

    attr_accessor :sum_amount_negative
    ...
    def self.swagger_types
      {
        ...
        :'balance_out' => :'Float',
        :'balance_in_currencies' => :'Array<Currency>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'balanceIn')
        self.balance_in = attributes[:'balanceIn']
      end

      if attributes.has_key?(:'balanceChange')
        self.balance_change = attributes[:'balanceChange']
      end

      if attributes.has_key?(:'balanceOut')
        self.balance_out = attributes[:'balanceOut']
      end

      if attributes.has_key?(:'balanceInCurrencies')
        if (value = attributes[:'balanceInCurrencies']).is_a?(Array)
          self.balance_in_currencies = value
        end
      end

      if attributes.has_key?(:'sumAmountNegative')
        self.sum_amount_negative = attributes[:'sumAmountNegative']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          supplier == o.supplier &&
          balance_in == o.balance_in &&
          balance_change == o.balance_change &&
          balance_out == o.balance_out &&
          balance_in_currencies == o.balance_in_currencies &&
          sum_amount_negative == o.sum_amount_negative
    end
    ...
    def hash
      [supplier, balance_in, balance_change, balance_out, balance_in_currencies, sum_amount_negative].hash
    end
