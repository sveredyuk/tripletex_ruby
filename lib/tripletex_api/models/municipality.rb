  ...
  class Municipality
    ...
    def list_invalid_properties
      ...
      if !@number.nil? && @number.to_s.length > 4
        invalid_properties.push("invalid value for 'number', the character length must be smaller than or equal to 4.")
      end
      ...
      if !@county.nil? && @county.to_s.length > 100
        invalid_properties.push("invalid value for 'county', the character length must be smaller than or equal to 100.")
      end
    ...
    def valid?
      return false if !@number.nil? && @number.to_s.length > 4
      return false if !@name.nil? && @name.to_s.length > 100
      return false if !@county.nil? && @county.to_s.length > 100
      return true
    end
    ...
    def number=(number)
      ...
      if !number.nil? && number.to_s.length > 4
        fail ArgumentError, "invalid value for 'number', the character length must be smaller than or equal to 4."
      end
    ...
    def county=(county)
      ...
      if !county.nil? && county.to_s.length > 100
        fail ArgumentError, "invalid value for 'county', the character length must be smaller than or equal to 100."
      end
    ...
    def hash
      [id, version, changes, url, number, name, county].hash
    end
