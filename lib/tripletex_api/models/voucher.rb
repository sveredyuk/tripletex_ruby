...
module TripletexApi
  ...
  class Voucher
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'reverseVoucher')
        self.reverse_voucher = attributes[:'reverseVoucher']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reverse_voucher == o.reverse_voucher &&
          postings == o.postings &&
          document == o.document &&
    ...
    def hash
      [id, version, changes, url, date, number, year, description, voucher_type, reverse_voucher, postings, document, attachment, edi_document].hash
    end
