...
module TripletexApi
  ...
  class BankReconciliationAdjustment
    ...
    attr_accessor :bank_reconciliation_match
    ...
    def self.swagger_types
      {
        :'payment_type' => :'BankReconciliationPaymentType',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bankTransactions')
        if (value = attributes[:'bankTransactions']).is_a?(Array)
          self.bank_transactions = value
        end
      end

      if attributes.has_key?(:'postingDate')
        self.posting_date = attributes[:'postingDate']
      end
      ...
      if attributes.has_key?(:'bankReconciliationMatch')
        self.bank_reconciliation_match = attributes[:'bankReconciliationMatch']
      end
    ...
    def list_invalid_properties
      ...
      if !@amount.nil? && @amount < 0.0
        invalid_properties.push("invalid value for 'amount', must be greater than or equal to 0.0.")
      end
    ...
    def valid?
      ...
      return false if !@amount.nil? && @amount < 0.0
      return true
    end
    ...
    def amount=(amount)
      ...
      if !amount.nil? && amount < 0.0
        fail ArgumentError, "invalid value for 'amount', must be greater than or equal to 0.0."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount == o.amount &&
          postings == o.postings &&
          bank_reconciliation_match == o.bank_reconciliation_match
    end
    ...
    def hash
      [payment_type, bank_transactions, posting_date, amount, postings, bank_reconciliation_match].hash
    end
