  ...
  class AppSpecific
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hourRegistrationEnabled')
        ...
        self.hour_registration_enabled = false
      end
    ...
    def hash
      [hour_registration_enabled, project_enabled, user_is_allowed_to_register_hours, payroll_accounting_enabled, user_is_auth_wage_menu, user_is_auth_my_salary, electronic_vouchers_enabled].hash
    end
