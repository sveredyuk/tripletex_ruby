...
module TripletexApi
  ...
  class SalarySpecification
    ...
    def list_invalid_properties
      ...
      if @salary_type.nil?
        invalid_properties.push("invalid value for 'salary_type', salary_type cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @salary_type.nil?
      return true
    end
    ...
    def hash
      [id, version, changes, url, rate, count, project, department, salary_type, payslip, employee, description, year, month, amount].hash
    end
