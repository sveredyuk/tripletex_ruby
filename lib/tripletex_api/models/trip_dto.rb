...
module TripletexApi
  ...
  class TripDTO
    ...
    attr_accessor :travel_time_in_minutes

    attr_accessor :sum_toll_nok
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'travelTimeInMinutes')
        self.travel_time_in_minutes = attributes[:'travelTimeInMinutes']
      end

      if attributes.has_key?(:'sumTollNOK')
        self.sum_toll_nok = attributes[:'sumTollNOK']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          distance == o.distance &&
          travel_time_in_minutes == o.travel_time_in_minutes &&
          sum_toll_nok == o.sum_toll_nok
    end
    ...
    def hash
      [distance, travel_time_in_minutes, sum_toll_nok].hash
    end
