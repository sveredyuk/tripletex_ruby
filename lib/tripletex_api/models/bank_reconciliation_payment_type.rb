...
module TripletexApi
  ...
  class BankReconciliationPaymentType
    attr_accessor :id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'debitAccount')
        self.debit_account = attributes[:'debitAccount']
      end
    ...
    def hash
      [id, version, changes, url, description, debit_account, credit_account, is_inactive].hash
    end
