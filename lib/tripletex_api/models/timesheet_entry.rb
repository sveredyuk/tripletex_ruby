...
module TripletexApi
  ...
  class TimesheetEntry
    ...
    def list_invalid_properties
      ...
      if @chargeable_hours.nil?
        invalid_properties.push("invalid value for 'chargeable_hours', chargeable_hours cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @chargeable_hours.nil?
    ...
    def hash
      [id, version, changes, url, project, activity, date, hours, chargeable_hours, employee, time_clocks, comment, locked, chargeable, invoice, hourly_rate, hourly_cost].hash
    end
