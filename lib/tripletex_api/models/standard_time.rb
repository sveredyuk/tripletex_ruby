...
module TripletexApi
  ...
  class StandardTime
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hoursPerDay')
        self.hours_per_day = attributes[:'hoursPerDay']
      end
    ...
    def list_invalid_properties
      ...
      if @hours_per_day.nil?
        invalid_properties.push("invalid value for 'hours_per_day', hours_per_day cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @hours_per_day.nil?
      return true
    end
    ...
    def hash
      [id, version, changes, url, employee, from_date, hours_per_day].hash
    end
