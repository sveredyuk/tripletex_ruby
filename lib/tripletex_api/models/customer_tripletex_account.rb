...
module TripletexApi
  ...
  class CustomerTripletexAccount
    ...
    def hash
      [administrator, customer_id, account_type, modules, type, send_emails, auto_validate_user_login, create_api_token, send_invoice_to_customer, customer_invoice_email, number_of_employees, number_of_vouchers, administrator_password].hash
    end
