...
module TripletexApi
  ...
  class CustomerTripletexAccount
    ...
    def customer_id=(customer_id)
      ...
      if !customer_id.nil? && customer_id < 1
        fail ArgumentError, "invalid value for 'customer_id', must be greater than or equal to 1."
      end
    ...
    def hash
      [administrator, customer_id, account_type, modules, type, send_emails, auto_validate_user_login, create_api_token, send_invoice_to_customer, customer_invoice_email, number_of_employees, number_of_vouchers, administrator_password, chart_of_accounts_type].hash
    end
