...
module TripletexApi
  ...
  class Product
    ...
    def hash
      [id, version, changes, url, name, number, cost_excluding_vat_currency, price_excluding_vat_currency, price_including_vat_currency, is_inactive, product_unit, is_stock_item, stock_of_goods, vat_type, currency, department, account].hash
    end
