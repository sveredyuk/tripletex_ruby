...
module TripletexApi
  ...
  class Banner
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bannerType')
        self.banner_type = attributes[:'bannerType']
      end
    ...
    def list_invalid_properties
      ...
      if @banner_type.nil?
        invalid_properties.push("invalid value for 'banner_type', banner_type cannot be nil.")
      end
      ...
      if @button.to_s.length > 255
        invalid_properties.push("invalid value for 'button', the character length must be smaller than or equal to 255.")
      end
      ...
      if @tag.to_s.length > 255
        invalid_properties.push("invalid value for 'tag', the character length must be smaller than or equal to 255.")
      end
    ...
    def valid?
      return false if @banner_type.nil?
      return false if @title.nil?
      return false if @title.to_s.length > 255
      return false if @message.nil?
      return false if @button.nil?
      return false if @button.to_s.length > 255
      return false if @link.nil?
      return false if @tag.nil?
      return false if @tag.to_s.length > 255
    ...
    def button=(button)
      ...
      if button.to_s.length > 255
        fail ArgumentError, "invalid value for 'button', the character length must be smaller than or equal to 255."
      end
    ...
    def tag=(tag)
      ...
      if tag.to_s.length > 255
        fail ArgumentError, "invalid value for 'tag', the character length must be smaller than or equal to 255."
      end
    ...
    def hash
      [id, version, changes, url, banner_type, title, message, button, link, tag, done].hash
    end
