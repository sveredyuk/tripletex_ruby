...
module TripletexApi
  ...
  class VNTCStatusDTO
    ...
    attr_accessor :external_sender_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ExternalSenderId')
        self.external_sender_id = attributes[:'ExternalSenderId']
      end

      if attributes.has_key?(:'ExternalMessageId')
        self.external_message_id = attributes[:'ExternalMessageId']
      end

      if attributes.has_key?(:'PartCount')
        self.part_count = attributes[:'PartCount']
      end
    ...
    def list_invalid_properties
      ...
      if @external_sender_id.nil?
        invalid_properties.push("invalid value for 'external_sender_id', external_sender_id cannot be nil.")
      end

      if @external_message_id.nil?
        invalid_properties.push("invalid value for 'external_message_id', external_message_id cannot be nil.")
      end
    ...
    def valid?
      ...
      return false if @external_sender_id.nil?
      return false if @external_message_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          external_sender_id == o.external_sender_id &&
    ...
    def hash
      [message_id, external_sender_id, external_message_id, part_count, status, operator].hash
    end
