...
module TripletexApi
  ...
  class Address
    ...
    def address_line1=(address_line1)
      ...
      if !address_line1.nil? && address_line1.to_s.length < 0
        fail ArgumentError, "invalid value for 'address_line1', the character length must be great than or equal to 0."
      end
    ...
    def postal_code=(postal_code)
      ...
      if !postal_code.nil? && postal_code.to_s.length > 100
        fail ArgumentError, "invalid value for 'postal_code', the character length must be smaller than or equal to 100."
      end
