...
module TripletexApi
  ...
  class Passenger
    ...
    attr_accessor :mileage_allowance
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'mileageAllowance')
        self.mileage_allowance = attributes[:'mileageAllowance']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          url == o.url &&
          name == o.name &&
          mileage_allowance == o.mileage_allowance
    end
    ...
    def hash
      [id, version, changes, url, name, mileage_allowance].hash
    end
