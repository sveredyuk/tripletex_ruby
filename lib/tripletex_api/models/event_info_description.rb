...
module TripletexApi
  ...
  class EventInfoDescription
    attr_accessor :description

    attr_accessor :payload_model
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'payloadModel')
        self.payload_model = attributes[:'payloadModel']
      end
    ...
    def hash
      [description, payload_model].hash
    end
