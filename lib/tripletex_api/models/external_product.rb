...
module TripletexApi
  ...
  class ExternalProduct
    ...
    def hash
      [id, version, changes, url, name, el_number, nrf_number, cost_excluding_vat_currency, price_excluding_vat_currency, price_including_vat_currency, is_inactive, product_unit, is_stock_item, vat_type, currency, department, account, discount_price].hash
    end
