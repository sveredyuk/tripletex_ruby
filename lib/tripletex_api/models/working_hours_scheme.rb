...
module TripletexApi
  ...
  class WorkingHoursScheme
    ...
    def list_invalid_properties
      ...
      if @working_hours_scheme.nil?
        invalid_properties.push("invalid value for 'working_hours_scheme', working_hours_scheme cannot be nil.")
      end
    ...
    def valid?
      return false if @working_hours_scheme.nil?
      working_hours_scheme_validator = EnumAttributeValidator.new('String', ["WORKING_HOURS_SCHEME"])
    ...
    def working_hours_scheme=(working_hours_scheme)
      validator = EnumAttributeValidator.new('String', ["WORKING_HOURS_SCHEME"])
    ...
    def hash
      [id, version, changes, url, working_hours_scheme, name_no, code].hash
    end
