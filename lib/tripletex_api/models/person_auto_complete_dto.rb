...
module TripletexApi
  ...
  class PersonAutoCompleteDTO
    ...
    def hash
      [name, alternate_name, address, postal_code, postal_area, latitude, longitude, score, sources, firstname, lastname, phone_number, phone_number_mobile, email, url, country_id].hash
    end
