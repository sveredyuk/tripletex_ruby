...
module TripletexApi
  ...
  class Job
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'interruptable')
        self.interruptable = attributes[:'interruptable']
      else
        self.interruptable = false
      end

      if attributes.has_key?(:'jobDetail')
        self.job_detail = attributes[:'jobDetail']
      end
    ...
    def hash
      [name, group, stateful, interruptable, job_detail, triggers].hash
    end
