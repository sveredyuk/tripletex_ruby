...
module TripletexApi
  ...
  class VoucherSearchResponse
    ...
    attr_accessor :total_number_of_postings
    ...
    def self.swagger_types
      {
        ...
        :'total_number_of_postings' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'totalNumberOfPostings')
        self.total_number_of_postings = attributes[:'totalNumberOfPostings']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          values == o.values &&
          total_number_of_postings == o.total_number_of_postings
    end
    ...
    def hash
      [full_result_size, from, count, version_digest, values, total_number_of_postings].hash
    end
