...
module TripletexApi
  ...
  class JobDetailDTO
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'jobclass')
        self.jobclass = attributes[:'jobclass']
      end

      if attributes.has_key?(:'jobData')
        if (value = attributes[:'jobData']).is_a?(Hash)
          self.job_data = value
        end
      end
    ...
    def hash
      [name, group, description, jobclass, job_data].hash
    end
