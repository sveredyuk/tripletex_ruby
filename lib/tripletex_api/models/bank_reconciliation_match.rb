...
module TripletexApi
  ...
  class BankReconciliationMatch
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["MANUAL", "PENDING_SUGGESTION", "REJECTED_SUGGESTION", "APPROVED_SUGGESTION"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["MANUAL", "PENDING_SUGGESTION", "REJECTED_SUGGESTION", "APPROVED_SUGGESTION"])
