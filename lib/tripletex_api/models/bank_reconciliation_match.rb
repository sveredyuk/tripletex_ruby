...
module TripletexApi
  ...
  class BankReconciliationMatch
    ...
    attr_accessor :bank_reconciliation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'bankReconciliation')
        self.bank_reconciliation = attributes[:'bankReconciliation']
      end
    ...
    def list_invalid_properties
      ...
      if @bank_reconciliation.nil?
        invalid_properties.push("invalid value for 'bank_reconciliation', bank_reconciliation cannot be nil.")
      end
    ...
    def valid?
      return false if @bank_reconciliation.nil?
      type_validator = EnumAttributeValidator.new('String', ["MANUAL", "PENDING_SUGGESTION", "REJECTED_SUGGESTION", "APPROVED_SUGGESTION", "ADJUSTMENT", "AUTO_MATCHED", "REJECTED_AUTO_MATCH"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["MANUAL", "PENDING_SUGGESTION", "REJECTED_SUGGESTION", "APPROVED_SUGGESTION", "ADJUSTMENT", "AUTO_MATCHED", "REJECTED_AUTO_MATCH"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          changes == o.changes &&
          url == o.url &&
          bank_reconciliation == o.bank_reconciliation &&
          type == o.type &&
    ...
    def hash
      [id, version, changes, url, bank_reconciliation, type, transactions, postings].hash
    end
