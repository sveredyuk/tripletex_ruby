...
module TripletexApi
  ...
  class TimesheetSettings
    ...
    attr_accessor :time_clock

    attr_accessor :timesheet_completed
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'timeClock')
        self.time_clock = attributes[:'timeClock']
      else
        self.time_clock = false
      end

      if attributes.has_key?(:'timesheetCompleted')
        self.timesheet_completed = attributes[:'timesheetCompleted']
      else
        self.timesheet_completed = false
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          changes == o.changes &&
          url == o.url &&
          time_clock == o.time_clock &&
          timesheet_completed == o.timesheet_completed
    end
    ...
    def hash
      [id, version, changes, url, time_clock, timesheet_completed].hash
    end
