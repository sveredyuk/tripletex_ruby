...
module TripletexApi
  ...
  class CSVRecord
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'recordNumber')
        self.record_number = attributes[:'recordNumber']
      end

      if attributes.has_key?(:'consistent')
        self.consistent = attributes[:'consistent']
      else
    ...
    def hash
      [comment, record_number, consistent].hash
    end
