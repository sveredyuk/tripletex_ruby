...
module TripletexApi
  ...
  class MileageAllowance
    ...
    def hash
      [id, version, changes, url, travel_expense, rate_type, rate_category, date, departure_location, destination, km, rate, amount, is_company_car, passengers].hash
    end
