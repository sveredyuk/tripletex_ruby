...
module TripletexApi
  ...
  class EmploymentDetails
    ...
    def hash
      [id, version, changes, url, employment, date, employment_type, remuneration_type, working_hours_scheme, occupation_code, percentage_of_full_time_equivalent, annual_salary, hourly_wage].hash
    end
