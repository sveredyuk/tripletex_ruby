  ...
  class Employee
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'allowInformationRegistration')
        ...
        self.allow_information_registration = false
      end
    ...
    def hash
      [id, version, changes, url, first_name, last_name, employee_number, date_of_birth, email, phone_number_mobile, phone_number_home, national_identity_number, dnumber, international_id, bank_account_number, user_type, allow_information_registration, is_contact, comments, address, department, employments].hash
    end
