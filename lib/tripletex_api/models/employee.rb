...
module TripletexApi
  ...
  class Employee
    ...
    def hash
      [id, version, changes, url, first_name, last_name, employee_number, date_of_birth, email, phone_number_mobile, national_identity_number, dnumber, bank_account_number, user_type, allow_information_registration, is_contact, address, department, employments].hash
    end
